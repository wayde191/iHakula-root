...
}return j})();(function(){d.register("elementObjectEvent",f);function f(h,g){return h.write('<object id="').reference(g._get(false,["values","eventId"]),g,"h").write('" wmode="transparent" classid="clsid:CB927D12-4FF7-4a9e-A169-56E4B8A75598" codebase="http://www.apple.com/qtactivex/qtplugin.cab#version=7,2,1,0"></object>')
...
}return j})();return d})()},{"./dust-runtime":"sAbXaO"}],12:[function(b,d,a){var c=b("./../shared/FeatureDetect");
var f=(function(){return{initialize:function(){c.htmlClass();return this}}}());
d.exports=f.initialize()},{"./../shared/FeatureDetect":13}],13:[function(c,f,b){var h=c("ac-base").Element;
...
},{"ac-base":false,"ac-browser":1,"ac-feature":5}]},{},[12]);