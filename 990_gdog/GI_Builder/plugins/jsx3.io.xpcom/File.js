...
Ab=netscape.security.PrivilegeManager.enablePrivilege;e.Xt=ub.a;try{Ab(e.Xt);e.lx={};e.lx.IU=Components.classes[ub.b].getService(Components.interfaces[ub.c]);e.lx.O1=Components.classes[ub.d].getService(Components.interfaces.nsIRDFService);}catch(Kb){jsx3.ide.LOG.fatal(jsx3.NativeError.wrap(Kb));}e._WINPATH=ub.e;b.getFile=function(d){if(typeof d==ub.f&&d.match(e._WINPATH))d=ub.g+d.replace(ub.h,ub.i);var
...
Ra=e.lx.IU.get(ub.l,Components.interfaces[ub.m]);return Ra!=null?jsx3.io.XPCOMFile.ir(this,Ra.parent):null;};b.getUserDocuments=function(){var
...
Lb=e.lx.O1.GetDataSource(ub.p);var
L=e.lx.O1.GetResource(ub.q);var
x=e.lx.O1.GetResource(ub.r);var
...
sa=493|jsx3.io.XPCOMFile.I2;var
N=e.lx.IU.get(ub.t,Components.interfaces[ub.m]);N.append(p);N.createUnique(0,sa);return jsx3.io.XPCOMFile.ir(this,N);};});jsx3.Class.defineClass("jsx3.io.XPCOMFile",jsx3.io.File,null,function(m,c){var
...
Ba=jsx3.io.File;m.BZ=false;var
M=netscape.security.PrivilegeManager.enablePrivilege;m.Xt=ub.a;try{M(m.Xt);m.lx={};m.lx._3=new
Components.Constructor(ub.b,ub.c,ub.d);m.lx.KZ=new
Components.Constructor(ub.e,ub.f);m.lx.Zw=new
Components.Constructor(ub.g,ub.h);m.lx.BV=Components.classes[ub.i].createInstance(Components.interfaces[ub.j]);m.lx.FX=Components.classes[ub.k].getService(Components.interfaces[ub.l]);m.BZ=true;}catch(Kb){jsx3.ide.LOG.error(ub.m,jsx3.NativeError.wrap(Kb));}m.isLoaded=function(){return m.BZ;};m.PATH_SEPARATOR=jsx3.app.Browser.getSystem()==jsx3.app.Browser.WIN32?ub.n:ub.o;m.FA=jsx3.app.Browser.getSystem()==jsx3.app.Browser.WIN32?3949:3967;m.I2=jsx3.app.Browser.getSystem()==jsx3.app.Browser.WIN32?146:128;c.h0=null;c.Z2=null;c.init=function(i,l){this.jsxsuper(i,l);M(m.Xt);if(l.getScheme()!=ub.p)throw new
jsx3.Exception(ub.q+l);try{this.Z2=m.lx.BV.getFileFromURLSpec(l.toString());this.h0=this.Z2.path;}catch(Kb){this.Z2=null;this.h0=l.getPath();}};c.write=function(l,a){if(!this.Z2)return false;if(!a)a={};var
sa=a.charset;var
Pa=a.linebreakmode;var
ib=a.charsetfailover;if(Pa)l=(l.split(ub.r)).join(Ba.LINE_SEP[Pa]);M(m.Xt);var
tb=493|m.I2;try{if(!this.Z2.exists())this.Z2.create(0,tb);var
Ha=Components.classes[ub.s].createInstance(Components.interfaces[ub.t]);Ha.init(this.Z2,32|2,tb,null);if(sa){var
ob=Components.classes[ub.u].createInstance(Components.interfaces.nsIConverterOutputStream);ob.init(Ha,sa,0,"?".charAt(0));ob.writeString(l);ob.close();}else{Ha.write(l,l.length);Ha.flush();}Ha.close();this.Z2=m.lx.BV.getFileFromURLSpec((this.toURI()).toString());return true;}catch(Kb){if(sa&&ib){jsx3.ide.LOG.error(ub.v+this+(sa?ub.w+sa:ub.x)+ub.y,jsx3.NativeError.wrap(Kb));return this.write(arguments[0],{linebreakmode:Pa});}else{jsx3.ide.LOG.error(ub.z+this+ub.y,jsx3.NativeError.wrap(Kb));return false;}}};c.read=function(){if(!this.Z2)return null;M(m.Xt);try{var
S=this.Z2.fileSize;var
Ab=m.lx.FX.newFileURI(this.Z2);var
C=m.lx.FX.newChannelFromURI(Ab);var
Y=new
m.lx.Zw();Y.init(C.open());var
...
yb=this.Z2.parent;}catch(Kb){return null;}if(yb!=null&&!yb.equals(this.Z2))return m.ir(this._fs,yb);}return null;};c.listFiles=function(){M(m.Xt);var
ja=jsx3.$A();if(this.Z2){var
z=this.Z2.directoryEntries;while(z.hasMoreElements()){var
va=(z.getNext()).QueryInterface(Components.interfaces[ub.c]);ja.push(m.ir(this._fs,va));}}return ja;};c.mkdir=function(){M(m.Xt);if(this.Z2){if(this.Z2.parent&&this.Z2.parent.exists()&&this.Z2.parent.isDirectory()){if(this.Z2.exists()){if(!this.Z2.isDirectory())throw new
...
ba=this.h0;if(jsx3.app.Browser.WIN32)if(this.h0.length<=3&&this.h0.charAt(1)==ub.I)ba=ba+ub.J;var
Va=new
m.lx._3(ba);Va.normalize();this.NB=Va.path;}catch(Kb){this.NB=this.h0;}}return this.NB;};c.getName=function(){M(m.Xt);return this.Z2&&this.Z2.leafName;};c.exists=function(){M(m.Xt);if(this.Z2!=null&&this.Z2.exists())if(this.Z2.isDirectory()){try{var
...
jsx3.Exception(ub.K+this+ub.L);if(z.exists())a.deleteFile();this.Z2.moveTo(ya,Bb);};c.isHidden=function(){M(m.Xt);return this.Z2&&this.Z2.exists()&&this.Z2.isHidden();};c.isReadOnly=function(){M(m.Xt);return this.Z2&&this.Z2.exists()&&!this.Z2.isWritable();};c.setReadOnly=function(e){if(this.exists()){M(m.Xt);if(e){this.Z2.permissions&=m.FA;}else this.Z2.permissions|=m.I2;}};c.getType=function(){return this.isDirectory()?ub.M:(this.getExtension()).toUpperCase()+ub.N;};c.getStat=function(){M(m.Xt);var
