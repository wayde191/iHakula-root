...
Ea=jsx3.io.File;var
ba=jsx3.io.FSOFileSystem;e.PATH_SEPARATOR=ub.a;e.fv=1;e.L8=2;e.vI=4;s.h0=null;s.init=function(g,k){this.jsxsuper(g,k);if(k!=null){if(k.getScheme()!=ub.b)throw new
jsx3.Exception(ub.c+k);this.h0=k.isAbsolute()&&k.getPath()?(k.getPath()).substring(1):k.getPath();if((jsx3.$S(this.h0)).endsWith(ub.d))this.h0+=ub.e;this.h0=this.h0.replace(ub.f,ub.a);}else this._uri=null;};s.write=function(l,a){if(!a)a={};var
db=a.charset;var
...
_=this.VN();return _!=null&&(_.Attributes&24)>0;};s.isFile=function(){var
Ib=this.VN();return Ib!=null&&(Ib.Attributes&24)==0;};s.getParentPath=function(){var
...
Ib=e.ir(this.getFileSystem(),ka.item());Ja.push(Ib);}ka=new
Enumerator(S.Files);for(;!ka.atEnd();ka.moveNext()){var
Ib=e.ir(this.getFileSystem(),ka.item());Ja.push(Ib);}}else throw new
jsx3.Exception(ub.s+this+ub.l);return Ja;};s.mkdir=function(){ba.k7.CreateFolder(this.getPath());};s.deleteFile=function(){var
jb=this.VN();if(jb!=null){jb.Delete();}else throw new
jsx3.Exception(ub.t+this+ub.l);};s.getPath=function(){if(this.h0==null&&this.XL!=null)this.h0=this.XL.Path;return this.h0;};s.getAbsolutePath=function(){if(this.NB==null){var
Qa=this.VN();if(Qa!=null){this.NB=Qa.Path;}else this.NB=ba.k7.GetAbsolutePathName(this.getPath());}return this.NB;};s.getName=function(){return ba.k7.GetFileName(this.getAbsolutePath());};s.renameTo=function(f){if(this.equals(f))throw new
jsx3.Exception(ub.u+this+ub.v);var
zb=this.VN();if(zb!=null){if(f.isFile())f.deleteFile();zb.Move(f.getPath());}else throw new
jsx3.Exception(ub.w+this+ub.l);};s.isHidden=function(){var
nb=this.VN();return nb!=null?(nb.Attributes&e.L8)>0:false;};s.isReadOnly=function(){var
xa=this.VN();return xa!=null?(xa.Attributes&e.fv)>0:false;};s.setReadOnly=function(d){var
J=this.VN();if(J!=null)if(d)J.Attributes|=e.fv;else if((J.Attributes&e.fv)>0)J.Attributes-=e.fv;};s.isRoot=function(){var
T=this.VN();return T!=null?T.IsRootFolder:false;};s.getType=function(){var
va=this.VN();return va!=null?va.Type:null;};s.getStat=function(){var
Wa=this.VN();if(Wa!=null){var
aa={mtime:new
Date(Wa.DateLastModified)};if(this.isFile())aa.size=Wa.Size;return aa;}else return null;};s.VN=function(){if(this.XL!=null)return this.XL;if(this.h0==null)return null;var
yb=this.getPath();if(ba.k7.FileExists(yb))this.XL=ba.k7.GetFile(yb);else if(ba.k7.FolderExists(yb))this.XL=ba.k7.GetFolder(yb);else this.XL=null;return this.XL;};s.toURI=function(){var
...
S=this.VN();if(S!=null){while(S.ParentFolder!=null)S=S.ParentFolder;return e.ir(this.getFileSystem(),S);}else{var
ma=this;while(!ma.exists()){var
lb=ma.getParentPath();if(!lb||ma.getPath()==lb)return null;ma=ba.getFile(lb);}if(ma.exists())return ma.getRootDirectory();}return null;};e.ir=function(n,m){var
M=new
e(n);M.XL=m;return M;};});
