...
u=this.getCache();this.setEditorText((u.getDocument(this.getCacheId())).toString());this.setDirty(false);this.publish({subject:ub.g});};n.save=function(){var
Ya=new
