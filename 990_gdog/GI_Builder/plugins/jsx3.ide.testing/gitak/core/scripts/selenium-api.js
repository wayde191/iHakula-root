...
Selenium.decorateFunctionWithTimeout = function(f, timeout) {
    ...
    if (isNaN(timeoutValue)) {
        ...
        timeoutValue = this.defaultTimeout; // -- gitak
    }
...
Selenium.prototype.reset = function() {
    // reset run interval too --gitak, dhwang
    htmlTestRunner.controlPanel.setRunInterval(0);
    this.defaultTimeout = Selenium.DEFAULT_TIMEOUT;
...
Selenium.prototype.doAddSelection = function(locator, optionLocator) {
   ...
   */
    ...
    var oplocator = this.optionLocatorFactory.fromLocatorString(optionLocator);
    var option = oplocator.findOption(element);
