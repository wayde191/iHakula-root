...
ub={a:"saved",b:"Cannot save file to blank url.",c:"editor"};m.save=function(){var
sb=this.getOpenFile();if(sb){var
u=this.getEditorText();if(jsx3.ide.writeUserFile(sb,u)){this.setDirty(false);this.publish({subject:ub.a});return true;}}else ((this.getPlugIn()).getLog()).error(ub.b);return false;};m.getPlugIn=function(){return jsx3.IDE.TextEditorPlugin;};m.render=function(f){var
