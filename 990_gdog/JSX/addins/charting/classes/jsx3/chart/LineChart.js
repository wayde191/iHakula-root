...
xa=null;if(this.type==ub.c)xa=this.Ln(x,ub.e);var
...
Ma=Ib.getXValue(ja);if(Ma!=null)jb=tb.getCoordinateForNoClip(Ma);}else if(jsx3.chart.isCategoryAxis(tb))jb=tb.getPointForCategory(bb);if(jb!=null&&cb!=null)Ib.Jf(ja,jb,cb,bb);else Ib.Ue(ja,jb,cb,bb);}Ib.updateView();T.appendChild(Ib.getCanvas());}};n.Bc=function(){return this.type==ub.b||this.type==ub.c;};n.tc=function(p){return p instanceof jsx3.chart.LineSeries;};e.getVersion=function(){return jsx3.chart.Cd;};});
