...
Ma=this.Cl();for(var
sb=0;sb<Ma.length;sb++)Ma[sb].setDimensions(Ha);};m.degreesToRadians=function(n){return jsx3.util.numMod(2*Math.PI/360*(-1*n+90),2*Math.PI);};m.getVersion=function(){return jsx3.chart.Cd;};});
