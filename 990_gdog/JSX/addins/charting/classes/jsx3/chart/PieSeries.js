...
G=jsx3.vector;i.Vs={top:1,right:1,bottom:1,left:1};h.init=function(q,e){this.jsxsuper(q,e);this.field=null;this.totalAngle=null;this.startAngle=null;this.colors=null;this.colorFunction=null;this.stroke=null;this.labelPlacement=ub.a;this.labelOffset=10;this.setTooltipFunction(ub.b);};h.getTotalAngle=function(){return this.totalAngle;};h.setTotalAngle=function(l){this.totalAngle=l==null?null:Math.max(0,Math.min(360,l));};h.getStartAngle=function(){return this.startAngle;};h.setStartAngle=function(a){this.startAngle=a==null?null:jsx3.util.numMod(a,360);};h.getField=function(){return this.field;};h.setField=function(q){this.field=q;};h.getValue=function(q){if(this.field)return jsx3.chart.asNumber(q.getAttribute(this.field));return null;};h.getColors=function(){return this.colors;};h.setColors=function(a){this.colors=a;};h.getLabelPlacement=function(){return this.labelPlacement!=null?this.labelPlacement:ub.a;};h.setLabelPlacement=function(g){if(i.Vs[g]){this.labelPlacement=g;}else throw new
jsx3.IllegalArgumentException(ub.c,g);};h.getLabelOffset=function(){return this.labelOffset!=null?this.labelOffset:0;};h.setLabelOffset=function(d){this.labelOffset=Math.round(d);};h.ue=function(m,d){var
...
x=this.getChart();if(x!=null)return x.ue(m,d);return new
G.Fill();};h.Ys=function(s){if(this.stroke)return G.Stroke.valueOf(this.stroke);var
Za=this.getChart();if(Za!=null){var
sb=Za.getSeriesStroke();if(sb)return G.Stroke.valueOf(sb);}return null;};h.xk=function(m,e,d,l,c,q,r,f){var
H=this.pj(ub.d);if(H==null){H=[];this.Rf(ub.d,H);}H.push([m,e,d,l,c,q,r,f]);};h.xm=function(){this.xk(null);};h.jj=function(){var
...
U=ba[Y][7];var
tb=new
G.Shape(null,0,0,hb,Ya);tb.setId(this.getId()+ub.e+Y);ob.appendChild(tb);tb.setFill(this.ue(ha,Y));tb.setStroke(this.Ys(Y));this.Zc(tb,Y,ha.getAttribute(ub.f));var
...
ha=k.getValue(o);return ha+ub.j+Math.round(d*10)/10+ub.k;};i.getVersion=function(){return jsx3.chart.Cd;};});
