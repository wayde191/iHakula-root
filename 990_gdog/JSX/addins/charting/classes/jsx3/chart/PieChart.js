...
ca=A*X/zb[R];E.xk(J,Gb,y,P,P+ca,Math.round(ma),Math.round(yb),100*X/zb[R]);P=P+ca;}E.updateView();N.appendChild(E.getCanvas());ma=ma+Za*(1+this.getSeriesPadding());}};g.Bc=function(){return true;};g.tc=function(c){return c instanceof jsx3.chart.PieSeries;};g.getLegendEntryType=function(){jsx3.require(ub.d);return 2;};n.defaultColoring=function(j,a){return jsx3.chart.Chart.DEFAULT_FILLS[a%jsx3.chart.Chart.DEFAULT_FILLS.length];};n.getVersion=function(){return jsx3.chart.Cd;};});
