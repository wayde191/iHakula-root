...
Hb=Ta[yb];Hb.Qn();for(var
lb=0;lb<Ia.length;lb++){var
Pa=Ia[lb];var
U=Hb.getXValue(Pa);var
t=Hb.getYValue(Pa);if(U==null||t==null)continue;U=Ra.getCoordinateForNoClip(U);t=jb.getCoordinateForNoClip(t);if(Hb instanceof jsx3.chart.PointSeries){Hb.Jf(Pa,lb,U,t);}else{var
fa=Hb.getMagnitudeValue(Pa);if(fa!=null)Hb.Jf(Pa,lb,U,t,fa);}}Hb.updateView();ob.appendChild(Hb.getCanvas());}};d.tc=function(s){return s instanceof jsx3.chart.PlotSeries;};p.getVersion=function(){return jsx3.chart.Cd;};});
