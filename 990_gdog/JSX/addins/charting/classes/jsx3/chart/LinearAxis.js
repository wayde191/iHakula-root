...
Ua=1;var
y=null,K=null;if(ib!=null){y=ib;}else{y=bb;Ua=Ua*n.q6;}if(B!=null){K=B;}else{K=Aa;Ua=Ua*n.q6;}var
xb=K-y;var
...
Ca=bb-(n.q6-1)*(Aa-bb)/2;ib=R*Math.floor(Ca/R);if(B!=null)ib=ib-B%R;}if(B==null){var
Eb=Aa+(n.q6-1)*(Aa-bb)/2;B=R*Math.ceil(Eb/R);if(ib!=null)B=B+ib%R;}this.Rf(ub.a,ib);this.Rf(ub.b,B);this.Rf(ub.c,R);return true;};d.fi=function(h){return this.pj(ub.a)+h*this.pj(ub.c);};d.ud=function(){var
Ma=this.pj(ub.b);var
Ya=this.pj(ub.a);var
W=this.pj(ub.c);var
Hb=[];var
Ca=Ya;while(Ca<=Ma&&Hb.length<n.MAX_TICKS){Hb.push(this.getCoordinateFor(Ca));Ca=Ca+W;}return Hb;};d.hd=function(){return this.pj(ub.a)<0&&this.pj(ub.b)>0;};d.getCoordinateFor=function(m){var
Lb=this.pj(ub.b);var
...
W=this.length*((Jb-ja)/(N-ja));return Math.round(this.horizontal?W:this.length-W);};n.getVersion=function(){return jsx3.chart.Cd;};});
