...
ub={a:"Fg",b:"vo",c:"qe",d:"_r",e:"jsxid"};d.init=function(c,a){this.jsxsuper(c,a);this.xField=null;this.yField=null;this.minField=null;};d.zo=jsx3.Method.newAbstract();d.zi=jsx3.Method.newAbstract();d.qk=jsx3.Method.newAbstract();d.getXValue=function(q){if(this.xField)return jsx3.chart.asNumber(q.getAttribute(this.xField));return null;};d.getYValue=function(p){if(this.yField)return jsx3.chart.asNumber(p.getAttribute(this.yField));return null;};d.getMinValue=function(b){if(this.minField)return jsx3.chart.asNumber(b.getAttribute(this.minField));return null;};d._getShownAreas=function(){var
Q=this.pj(ub.a);if(Q==null){Q=[];this.Rf(ub.a,Q);}return Q;};d.updateView=function(){this.jsxsuper();var
sa=this.bo();var
R=this.ql(sa);this.Rf(ub.b,sa);this.Rf(ub.c,R);var
...
fa=Ma!=null?Ma.apply(this,[e,o]):this.pj(ub.b);H.setFill(fa);H.setStroke(this.pj(ub.c));var
Lb=this.getTooltipFunction();if(Lb!=null)H.setToolTip(Lb.apply(this,[this,e]));this.Zc(H,o,e.getAttribute(ub.e));ia.appendChild(H);};d.De=function(){var
ca=this._getShownAreas();ca.splice(0,ca.length);};d.getXField=function(){return this.xField;};d.setXField=function(q){this.xField=q;};d.getYField=function(){return this.yField;};d.setYField=function(k){this.yField=k;};d.getMinField=function(){return this.minField;};d.setMinField=function(j){this.minField=j;};l.getVersion=function(){return jsx3.chart.Cd;};});jsx3.chart.BCSeries.prototype.drawBar=jsx3.chart.BCSeries.prototype.an;jsx3.chart.BCSeries.prototype.drawColumn=jsx3.chart.BCSeries.prototype.an;jsx3.Class.defineClass("jsx3.chart.BarSeries",jsx3.chart.BCSeries,null,function(k,a){var
ub={a:"jsx3.chart.BarSeries.tooltip",b:"{",c:",",d:"}",e:", y = "};k.DEFAULT_BARHEIGHT=10;a.init=function(b,m){this.jsxsuper(b,m);this.barHeight=null;this.setTooltipFunction(ub.a);};a.zo=function(o){return this.getXValue(o);};a.zi=function(l){return this.getYValue(l);};a.qk=function(){return this.getBarHeight();};a.getBarHeight=function(){return this.barHeight!=null?this.barHeight:k.DEFAULT_BARHEIGHT;};a.setBarHeight=function(j){this.barHeight=j;};k.tooltip=function(r,h){var
...
ub={a:"jsx3.chart.ColumnSeries.tooltip",b:"[ColumnSeries '",c:"']",d:"{",e:",",f:"}",g:", x = "};q.DEFAULT_COLUMNWIDTH=10;l.init=function(i,d){this.jsxsuper(i,d);this.columnWidth=null;this.setTooltipFunction(ub.a);};l.zo=function(j){return this.getYValue(j);};l.zi=function(b){return this.getXValue(b);};l.qk=function(){return this.getColumnWidth();};l.getColumnWidth=function(){return this.columnWidth!=null?this.columnWidth:q.DEFAULT_COLUMNWIDTH;};l.setColumnWidth=function(d){this.columnWidth=d;};l.toString=function(){return ub.b+this.getName()+ub.c;};l.an=function(d,n,e,j,p,i,b){if(b)this.jsxsuper(d,n,e,j,p,i,b);else this.jsxsuper(d,n,j,p,i,e,b);};q.tooltip=function(s,g){var
M=s.getXValue(g);var
