...
Q=i;if(typeof Q==ub.g)Q=jsx3.Class.forName(Q)||jsx3.lang.getVar(Q);if(Q instanceof jsx3.Class)Q=Q.getConstructor();if(typeof Q!=ub.h)Q=null;return Q;};o.Uh=function(h,n){var
...
ub=this.f5();ub[d]={ST:d,KK:i};};g.getBindableProps=function(){return (this.f5()).keys();};g.updateBindableOn=function(p,o,c){o.subscribe(c,(jsx3.$F(this.updateBindable)).bind(this,[p]));};g.updateBindable=function(f){var
Q=(this.f5())[f];this.setBindableProp(f,this.eval(Q.KK));};g.setBindableProp=function(q,p){var
...
La=jsx3.amp;i.READY=ub.a;i.EXTENDED=ub.b;i.jL=0;i.RJ=1;i.sH=2;o.init=function(){this.oK=i.jL;this.RL=jsx3.$A();this.KR=jsx3.$A();this.ry={};this.xt=jsx3.$A();this.Tw={};this.DI=jsx3.$A();this.Hr={};this.St=jsx3.$A();};o.setData=function(p){this.ST=p.getAttribute(ub.c);this.R8=p.getAttribute(ub.d)==ub.e;this.c7=p.getAttribute(ub.f);this.Dw=p.getAttribute(ub.g);var
ya=(p.getChildNodes()).toArray(true);for(var
E=0;E<ya.length;E++){var
qa=ya[E];var
Na=qa.getBaseName();if(Na==ub.h){for(var
ca=qa.selectNodeIterator(ub.i,La.getXmlNS(qa));ca.hasNext();)this.RL.push((ca.next()).getAttribute(ub.c));}else if(Na==ub.j){this.St.push(qa.getAttribute(ub.c));}else if(Na==ub.k){var
Ja=null;var
N=qa.getAttribute(ub.l);if(N){Ja=La.ej(N);if(!Ja)La.LOG.error(jsx3._msg(ub.m,N));}if(!Ja)Ja=La.ExtPoint;var
lb=new
Ja(this,qa);var
Q=lb.getLocalId();if(this.Tw[Q]){La.LOG.error(jsx3._msg(ub.n,this,Q));}else{La.Engine.Tb(lb,qa);this.Tw[Q]=lb;this.xt.push(lb);}}else if(Na==ub.o){var
Xa=null;var
V=qa.getAttribute(ub.l);if(V){Xa=La.ej(V);if(!Ja)La.LOG.error(jsx3._msg(ub.p,V));}if(!Xa)Xa=La.Ext;var
F=new
Xa(this,qa);var
Q=F.getLocalId();if(Q!=null)if(this.Hr[Q]){La.LOG.error(jsx3._msg(ub.q,this,Q));}else this.Hr[Q]=F;La.Engine.Tb(F,qa);this.DI.push(F);}}};o.setEngine=function(a){this.S9=a;};o.setPath=function(a){this.h0=a;this.ee=new
jsx3.net.URI(a+ub.r);this.Co=(jsx3.app.Browser.getLocation()).resolve(this.ee);};o.setResources=function(p){this.KR=jsx3.$A(p);this.ry={};for(var
Fb=0;Fb<p.length;Fb++){var
Pa=p[Fb];Pa.yk(this);if(!Pa.isLoaded())Pa.subscribe(La.Resource.READY,this,ub.s);this.ry[Pa.getLocalId()]=Pa;}};o.getId=function(){return this.ST;};o.isGlobal=function(){return this.R8;};o.getName=function(){return this.c7;};o.getVersion=function(){return this.Dw;};o.getResources=function(){return this.KR;};o.getEvents=function(){return this.St;};o.getResource=function(a){return this.ry[a];};o.getRequires=function(){return this.RL;};o.load=jsx3.$Y(function(s){if(this.oK==i.jL){La.LOG.debug(jsx3._msg(ub.t,this));this.oK=i.RJ;return this.S9.Sc(this);}else if(!this.isLoaded())this.subscribe(i.READY,(jsx3.$F(s.done)).bind(s));else s.done();});o.loaded=jsx3.$Y(function(c){if(this.isLoaded()){c.done();}else this.subscribe(i.READY,(jsx3.$F(c.done)).bind(c));});o.vB=function(k){};o.sj=function(){this.oK=i.sH;this.onLoaded();this.publish({subject:i.READY});};o.isLoaded=function(){return this.oK==i.sH;};o.getEngine=function(){return this.S9;};o.getServer=function(){return this.S9.getServer();};o.getExtPoints=function(){return this.xt;};o.getExtPoint=function(j){return this.Tw[j];};o.getExts=function(){return this.DI;};o.getExt=function(r){return this.Hr[r];};o.onRegister=function(){};o.onLoaded=function(){};o.onStartup=function(){};o.onExtension=function(n,k){this.publish({subject:i.EXTENDED,extpt:n,exts:k});};o.resolveURI=function(g){var
Nb=jsx3.net.URI.valueOf(g);if(Nb.getScheme()==ub.u&&!Nb.getHost())return (this.getServer()).resolveURI((Nb.getPath()).substring(1));if(!jsx3.net.URIResolver.isAbsoluteURI(Nb))Nb=this.ee.resolve(Nb);return jsx3.net.URIResolver.DEFAULT.resolveURI(Nb);};o.getUriPrefix=function(){return this.ee.toString();};o.relativizeURI=function(g,n){var
X=jsx3.app.Browser.getLocation();var
Ga=this.Co.relativize(X.resolve(g));if(Ga.isAbsolute()||n)return Ga;else return jsx3.net.URI.fromParts(ub.v,null,this.getId(),null,ub.r+Ga.getPath(),Ga.getQuery(),Ga.getFragment());};o.toString=function(){return this.ST;};o.getLog=function(){return jsx3.util.Logger.getLogger(this.getId());};o.loadRsrcComponent=function(q,j,b){if(!j)throw new
...
Aa=jsx3.amp;s.READY=ub.a;s.TYPE_SCRIPT=ub.b;s.TYPE_CSS=ub.c;s.TYPE_XML=ub.d;s.TYPE_XSL=ub.e;s.TYPE_JSS=ub.f;s.TYPE_BUNDLE=ub.g;s.LOAD_EARLY=ub.h;s.LOAD_NORMAL=ub.i;s.LOAD_MANUAL=ub.j;s.fQ={early:1,normal:1,manual:1};s.jL=0;s.RJ=1;s.sH=2;s.ll=function(d,e,o,p,l){var
t=new
s(null,o,p);t._j=d;t.ks=e;t.uT=l;return t;};i.init=function(c,d,h){this.u1=new
Aa.XML(h||{});this.CX=h;this.n0=c;this.ST=d;this.dD=jsx3.$A();this.oK=s.jL;this.iG=null;};i.yk=function(p){this.n0=p;delete this[ub.k];delete this[ub.l];delete this[ub.m];};i.attr=function(j){return this.u1.attr(j);};i.xml=function(){return this.CX;};i.getPlugIn=function(){return this.n0;};i.getId=function(){return (this.n0?this.n0.getId():this._j)+ub.n+this.ST;};i.getLocalId=function(){return this.ST;};i.getPath=function(){return this.attr(ub.o);};i.getFullPath=function(d){var
...
Ma=Aa.Uh(this.attr(ub.p),d);if(Ma){var
pb=Db.lastIndexOf(ub.n);if(pb<0||pb<Db.lastIndexOf(ub.r))pb=Db.length;Db=Db.substring(0,pb)+ub.n+Ma+Db.substring(pb);}}return Db;};i.getType=function(){return this.u1.nname();};i.getLoadType=function(){var
Ib=this.attr(ub.s);return s.fQ[Ib]?Ib:s.LOAD_NORMAL;};i.be=function(){return this.dD;};i.de=function(f,l){this.dD.push({id:f,type:l});};i.isLoaded=function(){return this.oK==s.sH;};i.loaded=jsx3.$Y(function(c){if(this.isLoaded()){c.done();}else this.subscribe(s.READY,(jsx3.$F(c.done)).bind(c));});i.load=jsx3.$Y(function(c){if(this.oK==s.jL){return (this.n0?this.n0.getEngine():this.uT).sf(this);}else if(!this.isLoaded())this.subscribe(s.READY,(jsx3.$F(c.done)).bind(c));else c.done();});i.Un=function(h){this.oK=s.RJ;};i.il=function(o){this.oK=s.sH;this.iG=o;this.publish({subject:s.READY});};i.getData=function(b){var
...
f(a);return f.JM[I];};f.Bd=function(b){var
...
ga=f.JM[Wa].getPlugIn(Lb);if(ga)return ga;}return null;});p.init=function(r){this.mz=r;this.j5=jsx3.$A();this.pQ={};this.MG={__ct:0};this.Tw={};this.Hr={};this.jx=0;this.SN=jsx3.util.EventDispatcher.jsxclass.newInnerClass();this.sU=0;this.WB={};this.mZ={};this.ev=new
db(this);this.qw=false;this.jV();};p.jV=jsx3.$Y(function(r){var
kb=new
...
A=f.JO(this.mz.resolveURI(da));var
Pa=this.uQ(A,Ga);var
T=this.dW(Pa);var
...
X=this.OL(Kb,Bb);P=P?P.and(X):X;}}if(P)return P;o.done();}else{na.LOG.error(jsx3._msg(ub.r,ra,ga));this.publish({subject:f.ERROR,xml:Mb});o.done();}}else{na.LOG.error(jsx3._msg(ub.s,Mb.getError()));this.publish({subject:f.ERROR,xml:Mb});o.done();}});p.OL=jsx3.$Y(function(l){var
...
O=Eb.getAttribute(ub.v);if(O)Ra=((jsx3.net.URI.valueOf(Ra)).resolve(O)).toString();return this.S5(Ra,Ba,_a?null:Eb);});p.S5=jsx3.$Y(function(s){var
D=s.args();var
...
Ka=i.args();var
B=Ka[0],Va=Ka[1],P=Ka[2];this.ev.JE(ub.w+Va);if(!P.hasError()){var
La=P.getBaseName();var
u=P.getNamespaceURI();if(La==ub.q&&na.isNS(u)){return this.aX(Va,B,P);}else{na.LOG.error(jsx3._msg(ub.y,Va,La,u));i.done();}}else{na.LOG.error(jsx3._msg(ub.z,Va,P.getError()));i.done();}});p.aX=jsx3.$Y(function(m){var
cb=m.args();var
Ga=cb[0],G=cb[1],Va=cb[2];var
M=Va.getAttribute(ub.t);if(!M||M!=Ga){na.LOG.error(jsx3._msg(ub.A,Ga,M));m.done();}else{var
Nb=na.Uh(Va.getAttribute(ub.B),(this.getServer()).getLocale());if(Nb){(this.gZ(G+ub.i+Ga,Va,Nb)).when((jsx3.$F(function(){m.done(this.Q0(Ga,G,Va));})).bind(this));}else return this.Q0(Ga,G,Va);}});p.gZ=jsx3.$Y(function(r){var
ga=r.args();var
Ka=ga[0],ab=ga[1],lb=ga[2];Ka=Ka+(ub.C+lb+ub.D);(f.JO(Ka)).when((jsx3.$F(function(k){if(k&&!k.hasError())this.Rs(ab,k);else na.LOG.error(jsx3._msg(ub.E,Ka,k?k.getError():null));r.done();})).bind(this));});f.YN={script:1,method:1,field:1,processor:1};f.xQ={script:1,method:1,field:1};p.Rs=function(e,g){if(g.getBaseName()!=ub.q||!na.isNS(g.getNamespaceURI())){na.LOG.error(jsx3._msg(ub.F,g.getSourceURL()));return;}(jsx3.$A(g.getAttributeNames())).each(function(l){e.setAttribute(l,g.getAttribute(l));});this.az(e,g,ub.G,f.YN);this.az(e,g,ub.H,f.xQ);};p.az=function(m,r,d,b){for(var
...
Jb=this.aW(ea,R);var
tb=this.Mx(ea,O,Jb);return jsx3.$Z(this._F,this)(ea,A,R,O,tb);});p.aW=jsx3.$Y(function(s){var
Xa=s.args();var
t=Xa[0],ea=Xa[1];var
...
++this.jx;var
Db=na.Resource.ll(a,i+ub.i+a+ub.i,T,Ka,this);for(var
la=Ka.selectNodeIterator(ub.S,na.getXmlNS(Ka));la.hasNext();){var
Ga=la.next();var
ca=Ga.getAttribute(ub.t);if(ca)Db.de(ca,ub.T);else Db.de(Ga.getAttribute(ub.q),ub.q);}ua.push(Db);Hb[T]=Db;}}return ua;};p.Q9=function(o){var
Va=jsx3.$A();for(var
Ba=o.selectNodeIterator(ub.U,na.getXmlNS(o));Ba.hasNext();)Va.push((Ba.next()).getAttribute(ub.t));return Va;};p.dS=function(){var
ca=this.ev.pct();var
...
Sa=0;Sa<Db.length;Sa++){na.LOG.debug(jsx3._msg(ub.Z,Db[Sa]));this.Tw[Db[Sa].getId()]=Db[Sa];}var
mb={};var
ia=ka.getExts();for(var
Sa=0;Sa<ia.length;Sa++){var
P=ia[Sa];var
Ya=P.getPointId();if(!this.Hr[Ya])this.Hr[Ya]=jsx3.$A();this.Hr[Ya].push(P);this.Hr[Ya].sort((jsx3.$F(function(h,i){var
Da=this.MG[(h.getPlugIn()).getId()]||0;var
Oa=this.MG[(i.getPlugIn()).getId()]||0;return Da>Oa?1:Da==Oa?0:-1;})).bind(this));na.LOG.debug(jsx3._msg(ub._,P,Ya));if(!mb[Ya])mb[Ya]=jsx3.$A();mb[Ya].push(P);}f.Tb(ka,d);for(var Ya in mb){var
Qa=this.Tw[Ya];if(Qa){(Qa.getPlugIn()).onExtension(Qa,mb[Ya]);Qa.onExtension(mb[Ya]);}}for(var
...
ea=((jsx3.$S(Cb.getAttribute(ub.ca)||ub.p)).trim()).split(ub.da);(jsx3.$A(ea)).each((jsx3.$F(function(e){if(e)ka.updateBindableOn(Ha,this.SN,e);})).bind(this));ka.subscribe(Ha,this,ub.ea);}(jsx3.$A(ka.getEvents())).each((jsx3.$F(function(q){ka.subscribe(q,this,ub.ea);})).bind(this));this.XR(ka,d,true);ka.onRegister();this.publish({subject:f.REGISTER,plugin:ka});};p.XR=function(q,m,d){var
...
Z=ub.sa+C[Xa].replace(ub.ta,ub.R)+ub.R+this.sU++;var
V=jsx3.eval(ub.ua+Z+ub.va+Q+ub.wa+Z+ub.xa);q[Z]=V;this.SN.subscribe(C[Xa],q,Z);}}};p.Mz=function(a){var
y=(jsx3.$O(a)).clone();y.subject=a.target.getId()+ub.ya+a.subject;na.LOG.debug(jsx3._msg(ub.za,y.subject));this.SN.publish(y);if(window.OpenAjax&&OpenAjax.hub)try{OpenAjax.hub.publish(y.subject,y);}catch(y){na.LOG.error(jsx3._msg(ub.Aa,y.subject),jsx3.NativeError.wrap(y));}};f.Tb=function(j,e){for(var
...
Wa=jsx3.eval(ub.ua+y+ub.Ka+Ka+ub.La+sa.getValue()+ub.wa+y+ub.xa);if(sa.getAttribute(ub.Ma)==ub.Ia)Wa=jsx3.$Y(Wa);}j[y]=Wa;}catch(Kb){na.LOG.error(jsx3._msg(ub.Na,sa.getAttribute(ub.t),j),jsx3.NativeError.wrap(Kb));}(sa.getParent()).removeChild(sa);}};f.r7=function(q){return function(){(this.load()).when((jsx3.$F(function(i,c){this[i].apply(this,c);})).bind(this,[q,arguments]));};};p.isLoaded=function(){return this.qw;};p.getServer=function(){return this.mz;};p.getPlugIns=function(){return this.j5;};p.getPlugIn=function(r){return this.pQ[r];};p.getExtPoint=function(a){return this.Tw[a];};p.getExts=function(r){return this.Hr[r]||jsx3.$A();};p.register=jsx3.$Y(function(s){var
aa=s.args();var
Q=aa[0];var
H=aa[1];var
ta=aa[2];if(this.pQ[Q])throw new
jsx3.IllegalArgumentException(ub.Oa+Q+ub.ya);this.MG[Q]=this.MG.__ct++;return this.S5(H,Q,ta);});p.deregister=function(i){var
Pa=this.getPlugIn(i);if(Pa){this.j5.remove(Pa);var
Ea=Pa.getExtPoints();for(var
Ha=0;Ha<Ea.length;Ha++){var
Lb=Ea[Ha].getId();delete this.Tw[Lb];delete this.Hr[Lb];}var
zb=Pa.getExts();for(var
Ha=0;Ha<zb.length;Ha++){var
Xa=zb[Ha];var
Gb=this.Hr[Xa.getPointId()];if(Gb)Gb.remove(Xa);}delete this.pQ[i];delete this.MG[i];delete this.WB[i];delete this.mZ[i];}};p.Sc=jsx3.$Y(function(r){var
ua=(r.args())[0];var
mb=this.FC(ua);var
t=new
...
Cb=this.WB[m.getId()];if(Cb){delete this.WB[m.getId()];delete this.mZ[m.getId()];this.XR(m,Cb,false);(m.getBindableProps()).each(function(i){m.updateBindable(i);});var
ga=Cb.getAttribute(ub.Ra);if(ga)jsx3.lang.setVar(m.isGlobal()?ga:(m.getServer()).getEnv(ub.e)+ub.ya+ga,m);}m.sj();na.LOG.debug(jsx3._msg(ub.Sa,m));};p.sf=jsx3.$Y(function(i){var
Fa=(i.args())[0];Fa.Un();var
Oa=this.cz(Fa,Fa.getPlugIn());(this.jH(Fa,Oa)).when(function(j){Fa.il(j);i.done();});});p.W1=jsx3.$Y(function(a){var
Ua=a.args();var
...
R=za[0];var
aa=null;var
Gb=R.be();Gb.each((jsx3.$F(function(r){var
...
Qa=this._getSiblingResource(R,r.id);if(Qa){if(!Qa.isLoaded())B=Qa.load();}else na.LOG.error(jsx3._msg(ub.Ua,r.id,R));}if(B)aa=aa?aa.and(B):B;})).bind(this));if(aa)return aa;else d.done();});p.xp=function(){this.qw=true;for(var
...
_a=(jsx3.$F(function(n){na.LOG.debug(jsx3._msg(ub.Za,E,Ga));this.ev.JE(N);o.done(n);})).bind(this);switch(sa){case ub.Ca:if(E.attr(ub.eb)==ub.Ia)(f.UK(Ga)).when((jsx3.$F(function(j){if(j!=null){var
kb=E.getPlugIn()||jsx3;try{var
Y=new
jsx3.util.Timer(ub.h,E.getId());kb.eval(j);Y.log(ub.fb);}catch(Kb){na.LOG.error(jsx3._msg(ub.gb,Ga,kb),jsx3.NativeError.wrap(Kb));}}else na.LOG.error(jsx3._msg(ub.hb,Ga));_a();})).bind(this));else (f.n1(Ga)).when(_a);break;case ub._a:(f.NZ(Ga)).when(_a);break;case ub.ab:(f.JO(Ga)).when((jsx3.$F(function(r){var
...
jsx3.xml.XslDocument(H.getFirstChild());(this.nP(ua,E.attr(ub.ib))).setDocument(E.attr(ub.jb)||E.getId(),pb);}else na.LOG.error(jsx3._msg(ub.ub,E));break;default:na.LOG.error(jsx3._msg(ub.kb,sa));}this.ev.JE(N);o.done(pb);}});f.JO=jsx3.$Y(function(k){var
Fb=k.args();var
qb=Fb[0],Pa=Fb[1];var
ta=(Pa||jsx3.xml.Document.jsxclass).newInstance();ta.setAsync(true);ta.subscribe(ub.vb,function(){k.done(ta);});ta.load(qb);});f.UK=jsx3.$Y(function(e){var
L=e.args();var
ga=L[0];var
...
Ma=(h.args())[0];var
Ca=document.createElement(ub.yb);Ca.href=Ma;Ca.rel=ub.zb;Ca.type=ub.pb;(document.getElementsByTagName(ub.qb))[0].appendChild(Ca);h.done();});f.n1=jsx3.$Y(function(a){return this.py((a.args())[0],ub.Ab);});f.h8=jsx3.$Y(function(h){var
F=(h.args())[0];var
ob=new
...
db=function(l){this._eng=l;this._ids={};this._total=0;this._donect=0;this._on=0;};(jsx3.$O(db.prototype)).extend({E2:function(){this._on=1;},G3:function(c){if(this._ids[c])na.LOG.warn(jsx3._msg(ub.Gb,c));else if(this._on){this._ids[c]=1;this._total++;this._eng.dS();}else this._ids[c]=-1;},JE:function(h){var
Xa=this._ids[h];if(Xa){delete this._ids[h];if(Xa>0){this._donect++;this._eng.dS();}}else na.LOG.warn(jsx3._msg(ub.Hb,h));},pct:function(){return this._total>0?this._donect/this._total:0;}});});jsx3.amp.Engine.gh();