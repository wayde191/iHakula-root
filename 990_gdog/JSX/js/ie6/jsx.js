...
ub={A:"jsxtabindex",B:"alpha(opacity=",C:")",D:"filter:alpha(opacity=",E:");",F:"text",G:"jsx:///images/icons/h.png",H:"jsx:///images/icons/v.png",I:"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='",J:"', sizingMethod='scale');",K:"_jsx_",L:"disable-output-escp",M:/&lt;/g,N:"<",O:/&gt;/g,P:">",Q:/&quot;/g,R:'"',S:/&amp;/g,T:"&",U:/&([a-zA-Z_]+);/g,V:"class",W:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,X:"&#",Y:";",Z:"jsx_image_loader",_:"none",a:' unselectable="on"',aa:"_",b:"overflow:hidden;",ba:"img",c:"body",ca:"id",d:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',da:"src",e:"beforeEnd",ea:"unshift",f:"_jsx3_html_b1",fa:"push",g:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ga:/\//g,h:"_jsx3_html_b2",ha:/\s+/g,i:"string",ia:" ",j:/^<([^\s]*)([\s\S]*)\/>$/i,k:"<$1$2></$1>",l:"scroll",m:"function",n:/\-(\w)/g,o:"head",p:"undefined",q:"http://www.w3.org/1999/xhtml",r:"style",s:"type",t:"text/css",u:"media",v:"screen",w:"object",x:"",y:"span",z:"div"};var
...
ra=r.getRelativePosition(null,e);aa=aa-ra.L;Ba=Ba-ra.T;}}return {L:aa,T:Ba,W:h.offsetWidth,H:h.offsetHeight};}};r.copy=function(i){window.clipboardData.setData(ub.F,i);};r.paste=function(){return window.clipboardData.getData(ub.F);};r.AU=jsx3.resolveURI(ub.G);r.z9=jsx3.resolveURI(ub.H);r.getCSSFade=function(o){return r.getCSSPNG(o?r.AU:r.z9);};r.getCSSPNG=function(k){return ub.I+k+ub.J;};r.getJSXParent=function(b,m){while(b!=null){if(b.id&&b.id.indexOf(ub.K)==0){var
u=m?m.getJSXById(b.id):jsx3.GO(b.id);if(u!=null)return u;}if(!b.parentNode){var
vb=b.parentWindow||b.defaultView;b=vb?vb.frameElement:null;}else b=b.parentNode;}return null;};r.removeOutputEscaping=function(i){var
la=i?[i]:[];while(la.length>0){var
Ea=la.shift();if(Ea.nodeName&&Ea.nodeName.toLowerCase()==ub.y&&Ea.className==ub.L){Ea.innerHTML=((((Ea.innerHTML.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.sA);Ea.removeAttribute(ub.V);}else if(Ea.childNodes)la.push.apply(la,this.nodesToArray(Ea.childNodes));}};r.removeOutputEscapingSpan=function(s){return s.replace(ub.W,function(a,g){return ((((g.replace(ub.M,ub.N)).replace(ub.O,ub.P)).replace(ub.Q,ub.R)).replace(ub.S,ub.T)).replace(ub.U,r.sA);});};r.HZ={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.sA=function(q,o){var
y=r.HZ[o];return y?ub.X+y+ub.Y:q;};r.ot=ub.Z;r.loadImages=function(j){var
A=document.getElementById(r.ot);if(A==null){var
Kb=(document.getElementsByTagName(ub.c))[0];if(Kb){A=document.createElement(ub.z);A.id=r.ot;A.style.display=ub._;Kb.insertBefore(A,Kb.firstChild);}else return;}var
Ca=jsx3.$A.is(j)?j:arguments;for(var
Nb=0;Nb<Ca.length;Nb++){if(!Ca[Nb])continue;var
hb=jsx3.resolveURI(Ca[Nb]);var
ob=r.ot+ub.aa+hb;if(document.getElementById(ob)==null){var
eb=document.createElement(ub.ba);eb.setAttribute(ub.ca,ob);eb.setAttribute(ub.da,hb);A.appendChild(eb);}}};r.updateRule=function(n,q,g){var
A=jsx3.html.getRuleByName(n);if(A)A.style[q]=g;};r.getElementById=function(b,n,i){return this.findElements(b,function(h){return h.id==n;},i,false,false,true);};r.getElementByTagName=function(b,s,i){s=s.toLowerCase();return this.findElements(b,function(o){return o.tagName.toLowerCase()==s;},i,false,false,true);};r.getElementsByTagName=function(p,n,f){n=n.toLowerCase();return this.findElements(p,function(j){return j.tagName.toLowerCase()==n;},f,true,false,true);};r.findElements=function(b,j,i,p,n,d){var
Mb=i?ub.ea:ub.fa;var
ja=p?[]:null;var
M=d?[b]:this.nodesToArray(b.childNodes);while(M.length>0){var
qa=M.shift();if(j.call(null,qa))if(p)ja[ja.length]=qa;else return qa;if(!n)M[Mb].apply(M,this.nodesToArray(qa.childNodes));}return ja;};r.getElmUpByTagName=function(o,d,h){return r.findElementUp(o,function(a){return a.nodeName.toLowerCase()==d;},h);};r.findElementUp=function(i,c,k){var
pa=i.ownerDocument.documentElement;var
aa=k?i:i.parentNode;while(aa!=null){if(c.call(null,aa))return aa;if(aa==pa)break;aa=aa.parentNode;}return null;};r.selectSingleElm=function(f,b){var
xb=1,y=arguments;if(arguments.length==2)if(typeof b==ub.i){xb=0;y=b.split(ub.ga);}else if(jsx3.$A.is(b)){xb=0;y=b;}var
Db=f;for(var
Ua=xb;Db!=null&&Ua<y.length;Ua++){var
Ka=y[Ua];if(!isNaN(Ka)){var
wa=Number(Ka);var
Z=Db.childNodes.length;var
Ma=0,Ga=0;for(;Ma<Z&&Ga<wa;Ma++)if(Db.childNodes[Ma].nodeType==1)Ga++;Db=Db.childNodes[Ma];}else throw new
jsx3.Exception();}return Db;};r.nodesToArray=function(f){var
da=new
Array(f.length);for(var
ba=0;ba<f.length;ba++)da[ba]=f[ba];return da;};r.getSelection=function(d){return new
r.Selection(d);};r.focusNext=function(l,a){var
x=l;while(x.lastChild)x=x.lastChild;while(!r.isFocusable(x)&&x!=l)x=x.previousSibling||x.parentNode;if(x!=l||r.isFocusable(x))if(x.onfocus!=null){var
D=x.onfocus;x.onfocus=null;x.focus();jsx3.sleep(function(){x.onfocus=D;});}else x.focus();};r.focusPrevious=function(e,h){var
x=this.findElements(e,function(j){return r.isFocusable(j);},true,false,false,true);if(x!=null)if(x.onfocus!=null){var
Ta=x.onfocus;x.onfocus=null;x.focus();jsx3.sleep(function(){x.onfocus=Ta;});}else x.focus();};r.focus=function(b){try{if(b.focus)b.focus();}catch(Kb){}};r.addClass=function(g,k){var
oa=g.className;if(oa){if(!(jsx3.$A(oa.split(ub.ha))).contains(k))g.className=oa+ub.ia+k;}else g.className=k;};r.removeClass=function(e,i){var
ia=e.className;if(ia&&ia.indexOf(i)>=0){var
Q=jsx3.$A(ia.split(ub.ha));if(Q.remove(i))e.className=Q.join(ub.ia);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(l,f){var
ub={a:"textarea",b:"EndToEnd",c:/\r\n|\r|\n/g,d:"character",e:"end"};f.init=function(o){this.DY=(o.ownerDocument.selection.createRange()).duplicate();this.K6=o;};f.getStartIndex=function(){var
Ya=this.K6.ownerDocument.selection.createRange();var
S=null;if(this.K6.tagName.toLowerCase()==ub.a){S=Ya.duplicate();S.moveToElementText(this.K6);}else S=this.K6.createTextRange();S.setEndPoint(ub.b,Ya);return S.text.length-Ya.text.length;};f.getEndIndex=function(){var
t=this.K6.ownerDocument.selection.createRange();var
wb=null;if(this.K6.tagName.toLowerCase()==ub.a){wb=t.duplicate();wb.moveToElementText(this.K6);}else wb=this.K6.createTextRange();wb.setEndPoint(ub.b,t);return wb.text.length;};f.setRange=function(c,s){var
Ka=this.K6.value;var
Wa=ub.c;Wa.lastIndex=0;var
kb=s;while(Wa.test(Ka)&&Wa.lastIndex<=kb){c=c-1;s=s-1;}var
db=this.K6.createTextRange();db.collapse(true);db.moveStart(ub.d,c);db.moveEnd(ub.d,s-c);db.select();};f.getOffsetLeft=function(){return this.DY.offsetLeft;};f.getOffsetTop=function(){return this.DY.offsetTop;};f.getText=function(){return this.DY.text;};f.setText=function(g){this.DY.text=g;};f.insertCaret=function(c){if(c==ub.e){this.DY.collapse();this.DY.select();}else throw new
