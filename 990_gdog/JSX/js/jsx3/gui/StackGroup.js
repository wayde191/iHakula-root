...
N=0,Ba=Aa,ca=nb,C=0;if(gb){C=Fb;ca=g.isFront()?nb-Ga*((this.getChildren()).length-1):Ga;}else{N=Fb;Ba=g.isFront()?Aa-Ga*((this.getChildren()).length-1):Ga;}return this.Ck(m,{boxtype:ub.c,left:N,top:C,width:ub.d,height:ub.d,parentwidth:Ba,parentheight:ca});};p.gi=function(m,j,e){var
...
Ya=this.ng(F,Ba);e.add(F,Ya,j!=null,true);}};p.paint=function(){var
