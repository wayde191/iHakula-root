...
ub={A:'" value="',B:'" ',C:"0/0/0",D:' checked="checked" ',E:" ",F:"3.0.00",G:"C0",H:"disabled",I:/<(input .*?)\/>/g,J:"<$1><xsl:if test=\"{0}='1'\"><xsl:attribute name=\"checked\">checked</xsl:attribute></xsl:if><xsl:if test=\"@jsxdisabled='1'\"><xsl:attribute name=\"disabled\">disabled</xsl:attribute></xsl:if></input>",K:"//record[@",L:"='1']",M:"1",a:"jsx30radio",b:"jsxselect",c:"input",d:"radio",e:"click",f:"keydown",g:"span",h:"",i:"relativebox",j:"box",k:"div",l:"inline",m:"input[radio]",n:"100%",o:"0 0 0 18",p:' id="',q:'"',r:' class="',s:"overflow-x:hidden;",t:' class="jsx30radio_tristate" ',u:' type="radio" ',v:"focus",w:"Vl",x:"blur",y:"cn",z:' name="'};k.UNSELECTED=0;k.SELECTED=1;k.DEFAULTCLASSNAME=ub.a;f.init=function(e,a,o,c,s,j,n,r,g){this.jsxsuper(e,a,o,c,s,j);this.setGroupName(r);this.setValue(n);this.setDefaultSelected(g==null?1:g);if(g!=null)this.setSelected(g);};f.getGroupName=function(){return this.jsxgroupname;};f.setGroupName=function(e){this.jsxgroupname=e;};f.Pb=function(c,j){this.focus(j);if(!c.leftButton()&&c.isMouseEvent())return;if(this.getSelected()!=1){var
ob=this.doEvent(ub.b,{objEVENT:c,_gipp:1});if(ob!==false)this.setSelected(1,j);}};f._ebKeyDown=function(s,m){if(s.enterKey()){this.Pb(s,m);s.cancelAll();}};f.getDefaultSelected=function(){return this.jsxdefaultselected;};f.setDefaultSelected=function(g){this.jsxdefaultselected=g;return this;};f.getSelected=function(){return this.jsxselected!=null?this.jsxselected:this.getDefaultSelected();};f.setSelected=function(q,a){q=q!=null?q:1;this.jsxselected=q;if(a==null)a=this.getRendered();if(a){(jsx3.html.selectSingleElm(a,0,0,0)).checked=q==1;if(q==1){var
...
Aa=new
jsx3.gui.Painted.Box(yb);Ga.Td(Aa);yb={};yb.tagname=ub.g;yb.boxtype=ub.j;yb.width=16;yb.parentheight=Ga.Zg();yb.height=18;var
_=new
jsx3.gui.Painted.Box(yb);Aa.Td(_);yb={};yb.tagname=ub.m;yb.empty=true;yb.omitpos=true;var
Za=new
jsx3.gui.Painted.Box(yb);_.Td(Za);yb={};yb.tagname=ub.g;yb.boxtype=ub.l;yb.top=2;yb.parentheight=Ga.Zg();yb.height=ub.n;yb.padding=ub.o;var
Ca=new
jsx3.gui.Painted.Box(yb);Ga.Td(Ca);return Ga;};f.paint=function(){this.applyDynamicProperties();var
ea=this.getEnabled()==1;var
Ia=ea?this.Bf(k.ld,0):ub.h;var
Q=this.renderAttributes(null,true);var
H=this.Wl(true);H.setAttributes(ub.p+this.getId()+ub.q+this.Wb()+ub.r+this.dd()+ub.q+this.Do()+this.Wn()+Ia+Q);H.setStyles((H.getPaintedWidth()?ub.s:ub.h)+this.yg(true)+this.Gd()+this.Di()+this.We()+this.Kh()+this.Uc()+this.qg()+this.Ne()+this.Kk()+this.Vg());var
Ba=H.lg(0);var
Ib=Ba.lg(0);Ib.setAttributes(ub.t);var
O=Ib.lg(0);O.setAttributes(ub.u+this.pi(ub.v,ub.w,3)+this.pi(ub.x,ub.y,3)+ub.z+this.getGroupName()+ub.A+this.getValue()+ub.B+this.Wn()+this.paintSelected()+this.md());var
Ja=H.lg(1);Ja.setAttributes(jsx3.html.pe);return (H.paint()).join((Ba.paint()).join((Ib.paint()).join((O.paint()).join(ub.h))+(Ja.paint()).join(this.ii())));};f.focus=function(b){if(!b)b=this.getRendered();if(b)jsx3.html.focus(jsx3.html.selectSingleElm(b,ub.C));};f.paintSelected=function(){return this.getSelected()==1?ub.D:ub.h;};f.dd=function(){var
