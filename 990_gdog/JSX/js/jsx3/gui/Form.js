...
db=this.getEnabled()!=0?this.getBackgroundColor():this.getDisabledBackgroundColor();return db?ub.f+db+ub.g:ub.h;};c.getDisabledColor=function(){return this.jsxdisabledcolor;};c.setDisabledColor=function(j){this.jsxdisabledcolor=j;return this;};c.getEnabled=function(){return this.jsxenabled==null?1:this.jsxenabled;};c.getValue=function(){return this.jsxvalue;};c.setValue=function(g){this.jsxvalue=g;return this;};c.setEnabled=function(a,g){if(this.jsxenabled!=a){this.jsxenabled=a;if(g)this.repaint();}return this;};c.Kh=function(){if(this.getEnabled()!=0){var
Ea=this.getColor();return Ea?ub.i+Ea+ub.g:ub.h;}else return ub.i+(this.getDisabledColor()?this.getDisabledColor():p.DEFAULTDISABLEDCOLOR)+ub.g;};c.Wn=function(){return this.getEnabled()==1?ub.h:ub.j;};c.md=function(){return jsx3.gui.Block.prototype.md.call(this,this.getIndex()||Number(0));};c.yg=function(j){var
