...
Bb={};Bb.parentwidth=pb.Sh();Bb.parentheight=pb.Zg();Bb.height=ub.r;if(g.width){Bb.width=ub.r;Bb.tagname=ub.s;Bb.boxtype=ub.t;}else{Bb.tagname=ub.o;Bb.boxtype=ub.m;}var
Lb=new
jsx3.gui.Painted.Box(Bb);pb.Td(Lb);return pb;};b.paint=function(){this.applyDynamicProperties();var
...
Ia=this.Bf(this.getEnabled()==1?r.ld:null,0);var
Ua=this.renderAttributes(null,true);var
Ra=this.Wl(true);Ra.setAttributes(ub.u+this.getId()+ub.v+this.Wb()+this.Do()+Ia+ub.w+this.dd()+ub.v+Ua);Ra.setStyles(this.qg()+this.Ne()+this.yg(true)+this.Di()+this.Gd()+this.We()+this.Kh()+this.Uc()+this.Kk()+this.Ak()+this.Vg());var
ca=Ra.lg(0);ca.setAttributes(this.md()+ub.x);ca.setStyles(this.Ak()+this.Bj());return (Ra.paint()).join((ca.paint()).join(this.ii())+this.paintChildren());};b.setRelativePosition=function(f,e){if(this.jsxrelativeposition!=f){this.jsxrelativeposition=f;this.ce();if(e)this.repaint();}return this;};b.setWidth=function(o,j){this.jsxwidth=o;this.ce();if(j)this.repaint();return this;};b.Uc=function(){var
