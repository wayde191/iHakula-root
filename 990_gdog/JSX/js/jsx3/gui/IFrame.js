...
K=this.getSrc();K=K?ub.d+(this.getUriResolver()).resolveURI(K)+ub.e:ub.f;return ub.g+this.getId()+ub.h+this.qg()+this.Ne()+this.Vg()+ub.e+this.renderAttributes()+ub.i+ub.j+this.getId()+ub.k+K+this.M8()+this.pi(ub.l,ub.m,1)+ub.n+ub.o;};s.getIFrame=function(){try{return this.eval(this.getId()+ub.p);}catch(Kb){return null;}};s.getContentDocument=function(){try{var
...
ca=p.Bw[this.jsxscroll];return ca?ub.t+ca+ub.e:ub.f;};s.onSetChild=function(i){return false;};s.Jm=function(q){return null;};s.gi=function(r,o,l){};});
