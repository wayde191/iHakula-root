...
u=parseInt(t.offsetHeight)-parseInt(lb.offsetHeight);lb.style.left=Math.round((l.gT-l.KP)/2)+ub.i;lb.style.top=u-Math.round(this.getValue()*u/l.L5)+ub.i;}}};r.gi=function(f,c,h){var
...
Mb=Ma.lg(0);Mb.recalculate({width:Ma.Sh(),height:Ma.Zg()},c?c.childNodes[0]:null,h);var
va=Mb.lg(0);va.recalculate({width:Mb.Sh(),height:Mb.Zg()},c?c.childNodes[0].childNodes[0]:null,h);if(Z)this.Ku();}};r.Jm=function(g){if(this.getParent()&&(g==null||isNaN(g.parentwidth)||isNaN(g.parentheight))){g=(this.getParent()).ng(this);}else if(g==null)g={};var
...
Ca={};Ca.tagname=ub.p;Ca.boxtype=ub.q;Ca.width=cb.Sh();Ca.height=cb.Zg();var
P=Math.round((l.gT-l.M6)/2)+ub.r;var
C=ub.s;Ca.padding=W?P+C+P+C:C+P+C+P;var
Ka=new
jsx3.gui.Painted.Box(Ca);cb.Td(Ka);Ca={};Ca.tagname=ub.p;Ca.boxtype=ub.q;if(W){Ca.height=l.M6;Ca.width=Ka.Sh();}else{Ca.height=Ka.Zg();Ca.width=l.M6;}Ca.border=this.getBorder()?this.getBorder():this.getOrientation()==0?l.NR:l.Qo;var
Va=new
jsx3.gui.Painted.Box(Ca);Ka.Td(Va);var
ob=W?Math.round(this.getValue()/l.L5*(Ka.Sh()-l.rI)):Math.floor((l.gT-l.KP)/2);var
ja=W?Math.floor((l.gT-l.KP)/2):Math.round(Ka.Zg()-l.rI-this.getValue()/l.L5*(Ka.Zg()-l.rI));var
Db=W?l.rI:l.KP;var
oa=W?l.KP:l.rI;Ca={};Ca.tagname=ub.p;Ca.boxtype=ub.m;Ca.left=ob;Ca.top=ja;Ca.width=Db;Ca.height=oa;var
Ya=new
jsx3.gui.Painted.Box(Ca);cb.Td(Ya);Ca={};Ca.tagname=ub.p;Ca.boxtype=ub.q;Ca.width=Db;Ca.height=oa;var
wa=new
jsx3.gui.Painted.Box(Ca);Ya.Td(wa);return cb;};r._ebKeyDown=function(b,k){if(!b.hasModifier())if(b.isArrowKey()){if(b.upArrow()||b.rightArrow())this.G6(b,1);else if(b.downArrow()||b.leftArrow())this.G6(b,-1);b.cancelAll();}};r.lk=function(e,h){var
...
ra=this.doEvent(ub.t,{objEVENT:f,fpPREVIOUS:this.jsxvalue,fpVALUE:Ab});if(ra!==false)this.setValue(Ab);}};l.ld={};l.ld[ub.u]=true;l.ld[ub.v]=true;r.paint=function(){this.applyDynamicProperties();var
na=this.getOrientation()==0;var
t=this.getEnabled()==1;var
Hb=this.Bf(t?l.ld:null,0);var
sb=this.renderAttributes(null,true);var
D=this.Wl(true);D.setAttributes(ub.w+this.getId()+ub.x+this.md()+this.Do()+this.Wb()+Hb+sb);D.setStyles(this.Bj()+this.Kk()+this.qg()+this.Ne());var
v=D.lg(0);var
...
G=this.getBackground()||ub.o;return G||this.Uc()?G+ub.Q:this.getOrientation()==0?l.oP:l.I1;};l.getVersion=function(){return ub.R;};});jsx3.Slider=jsx3.gui.Slider;
