...
ua=new
jsx3.gui.Painted.Box(Bb);wb.style.left=ua.getPaintedLeft()+ub.w;wb.style.top=ua.getPaintedTop()+ub.w;wb.style.width=ua.getPaintedWidth()+ub.w;wb.style.height=ua.getPaintedHeight()+ub.w;wb.style.fontName=s.style.fontName;wb.style.fontSize=s.style.fontSize;wb.style.textAlign=s.style.textAlign;wb.style.fontWeight=s.style.fontWeight;wb.style.visibility=ub.y;jsx3.gui.Painted.He(wb,ua.wg(),ub.M);wb.innerHTML=Ba.getOuterHTML(s.childNodes[0]);this._jsxZ8=s.offsetLeft+Xa;this._jsxJW=s.cellIndex;jsx3.gui.Event.subscribe(ub.z,this,ub.N);jsx3.gui.Interactive._beginMove(e,wb,false,true);};o.al=function(r,n){var
...
k=_a;q.releaseCapture(_a);_a.style.visibility=ub.Q;if(this._jsxZ8==parseInt(_a.style.left)){this.al(q,k);}else if(this.getCanReorder()!=0){var
...
Pa=jsx3.GO(Ib);k.style.fontWeight=ub.aa;if(Pa!=null)Pa._jsxcg=null;};m.doFocusItem=function(k){var
L=k.getAttribute(ub._);var
xa=k.id.substring(0,k.id.length-(L.length+1));var
Hb=jsx3.GO(xa);if(Hb==null){Ab.warn(ub.ba+xa+ub.ca);return;}if(!Hb.kk(L))return;Ba.focus(k);k.style.fontWeight=ub.da;Hb._jsxcg=k;};o.Xg=function(q,c){if(this.getCanDrag()==1&&q.leftButton()){var
Ea=q.srcElement();var
S=this.OI(Ea);if(S[0]!=null){if(!this.kk(S[0]))return;ta.publish(q);this.doDrag(q,S[2],m.PC,{strRECORDID:S[0],intCOLUMNINDEX:S[1]});}}};o.eo=function(r,n){var
...
ca=null;var
Mb=null;var
Bb=null;while(a!=null&&ca==null){if(a.tagName&&a.tagName.toLowerCase()==ub.ja)Mb=a.getAttribute(ub.ka);else if(a.tagName&&a.tagName.toLowerCase()==ub.la){ca=a.getAttribute(ub._);Bb=a;}a=a.parentNode;}return [ca,ca?Mb:null,Bb];};o.K7=function(e,n,p){if(!this.kk(n.getAttribute(ub._)))return;if(!this.kk(p.getAttribute(ub._)))return;if(this.getMultiSelect()==2)return;var
Fa=0;var
...
sb=jb.childNodes[lb];O.push(sb.getAttribute(ub._),sb);}if(Fa==2)break;}this.gy(e,O,Q,false);m.doFocusItem(n);};o._ebKeyDown=function(c,j){if(this.jsxsupermix(c,j))return;if(this._jsxcg==null)return;var
Ib=(this.getId()).length;var
A=c.keyCode();var
U=this.getMultiSelect()==1;var
ua=false;var
Aa=jsx3.gui.isMouseEventModKey(c);if(A==38){if(this._jsxcg==this._jsxcg.parentNode.firstChild)return;if(U&&Aa){m.doFocusItem(this._jsxcg.previousSibling);}else if(U&&c.shiftKey()){this.K7(c,this._jsxcg.previousSibling,this._jsxV6);}else{var
R=this._jsxcg.previousSibling;this.GI(c,R.getAttribute(ub._),R,false);}ua=true;}else if(A==40){if(this._jsxcg==this._jsxcg.parentNode.lastChild)return;if(U&&Aa){m.doFocusItem(this._jsxcg.nextSibling);}else if(U&&c.shiftKey()){this.K7(c,this._jsxcg.nextSibling,this._jsxV6);}else{var
R=this._jsxcg.nextSibling;this.GI(c,R.getAttribute(ub._),R,false);}ua=true;}else if(A==13){this.gk(c);ua=true;}else if(A==32){if(U&&Aa){var
B=this._jsxcg.getAttribute(ub._);if(this.isSelected(B)){this.sZ(c,B,this._jsxcg);}else this.GI(c,B,this._jsxcg,true);}else if(U&&c.shiftKey()){this.K7(c,c.srcElement(),this._jsxV6);}else{var
R=this._jsxcg;this.GI(c,R.getAttribute(ub._),R,false);}ua=true;}else if(A==9&&c.shiftKey()){this.focus();ua=true;}else if(A==9){Ba.focus((this.getRendered()).lastChild);ua=true;}if(ua)c.cancelAll();};o.Pb=function(d,i){var
sa=false;var
...
Ha=Oa.getAttribute(ub._);if(this.isSelected(Ha)){this.sZ(d,Ha,Oa);}else{this.GI(d,Ha,Oa,true);m.doFocusItem(Oa);}sa=true;}else{if(this.isSelected(Oa.getAttribute(ub._))){if(Ya||d.shiftKey())this.sZ(d,Oa.getAttribute(ub._),Oa);}else this.GI(d,Oa.getAttribute(ub._),Oa,false);sa=true;}if(sa){d.cancelBubble();d.cancelReturn();}};o.Zn=function(n,r){this.gk(n);};o.executeRecord=function(e){var
ya=this.getRecordNode(e);if(ya!=null)this.eval(ya.getAttribute(ub.oa),{strRECORDID:e});};o.doExecute=function(n){this.gk(this.isOldEventProtocol(),n!=null?[n]:null);};o.gk=function(i,e){if(e==null)e=this.getSelectedIds();for(var
Qa=0;Qa<e.length;Qa++){var
Bb=e[Qa];var
sa=this.getRecordNode(Bb);if(sa.getAttribute(ub.pa)==ub.qa)continue;this.eval(sa.getAttribute(ub.oa),{strRECORDID:Bb});}if(e.length>0&&i)this.doEvent(ub.oa,{objEVENT:i instanceof ta?i:null,strRECORDID:e[0],strRECORDIDS:e});};o.isSelected=function(n){return (this.getXML()).selectSingleNode(ub.ra+n+ub.sa+ub.ta+ub.ua)!=null;};o.doSelect=function(c,d,b,r){this.GI(!b&&this.isOldEventProtocol(),c,null,true);if(c&&r)this.revealRecord(c);return this;};o.selectRecord=function(r){if(!this.kk(r))return;if(this.getMultiSelect()==2)return;this.GI(false,r,null,true);return this;};o.deselectRecord=function(l){this.sZ(false,l,null);return this;};o.deselectAllRecords=function(){this.a1(false,this.getSelectedIds(),[]);return this;};o.GI=function(n,l,d,i){var
...
qb=this.GI(false,i[wa],k[wa],true);if(!qb){i.splice(wa,1);k.splice(wa,1);wa--;}}if(e&&i.length>0){this.doEvent(ub.va,{objEVENT:e,strRECORDID:i[0],strRECORDIDS:i});this.doEvent(ub.wa,{objEVENT:e});}};o.sZ=function(r,h,f){var
...
Hb=this.sZ(false,h[_a],j[_a]);if(!Hb){h.splice(_a,1);j.splice(_a,1);_a--;}}if(f&&h.length>0){this.doEvent(ub.va,{objEVENT:f,strRECORDID:h[0],strRECORDIDS:h});this.doEvent(ub.wa,{objEVENT:f});}};o.focusRecord=function(l){var
Fa=this.D8(l);if(Fa!=null)Ba.focus(Fa);return this;};o.doDeselect=function(n,k){this.sZ(this.isOldEventProtocol(),n,null);return this;};o.getActiveRow=function(){return this._jsxV6;};o.revealRecord=function(l,p){var
...
aa=this;k.rj();m.BF=window.setTimeout(function(){if(!this.getParent())return;var
U={objEVENT:k,strRECORDID:tb[0],intCOLUMNINDEX:tb[1]};var
K=aa.doEvent(ub.Ca,U);if(K){jsx3.gui.Interactive.hideSpy();aa.showSpy(K,k);}},jsx3.EventHelp.SPYDELAY);}}};o.nk=function(){if(m._curSpyRow){this.removeSpyStyle(m._curSpyRow);delete m[ub.Da];}window.clearTimeout(m.BF);jsx3.gui.Interactive.hideSpy();};m.ld={};m.ld[ub.Ea]=true;m.ld[ub.Fa]=true;m.ld[ub.O]=true;m.ld[ub.Ga]=true;m.ld[ub.Ha]=true;m.ld[ub.Ia]=true;m.ld[ub.z]=true;o.gi=function(e,b,n){var
...
Ca=ub.Oa+Ua+ub.Pa+ub.Qa+ub.D+this.Ne()+this.qg()+this.Bj()+this.Uc()+this.ti()+ub.Ra+this.Wb()+this.renderAttributes()+ub.Sa;Ca=Ca+ub.Ta;if(_a>0){Ca=Ca+(ub.Ua+_a+ub.Va);Ca=Ca+(ub.Oa+Ua+ub.Wa+this.co()+this.dk()+ub.Xa);Ca=Ca+this.Ti();Ca=Ca+ub.Ya;Ca=Ca+(ub.Oa+Ua+ub.Za+ub._a);Ca=Ca+ub.ab;V=ub.bb;}var
Za=this.Bf(m.ld,5);var
Q=N.parentheight-_a;Ca=Ca+(ub.Ua+(_a==0?ub.J:Q)+ub.cb+Q+ub.w+ub.Xa);Ca=Ca+(ub.Oa+Ua+ub.db+Za+V+ub.eb+this.Uc()+this.getBorder()+ub.fb+Q+ub.w+ub.gb);Ca=Ca+this.mf();Ca=Ca+this.uo();Ca=Ca+ub.Ya;Ca=Ca+ub.ab;Ca=Ca+ub.hb;Ca=Ca+C;Ca=Ca+ub.Ya;return Ca;};o.Uc=function(){return ub.ib+(this.getBackgroundColor()?this.getBackgroundColor():m.DEFAULTBACKGROUNDCOLOR)+ub.jb;};o.ti=function(){return this.getBackground()?this.getBackground()+ub.jb:ub.D;};o.co=function(){return ub.ib+(this.getBackgroundColorHead()?this.getBackgroundColorHead():m.DEFAULTBACKGROUNDCOLORHEAD)+ub.jb;};o.dk=function(){return this.getBackgroundHead()?this.getBackgroundHead()+ub.jb:m.DEFAULTBACKGROUNDHEAD;};o.dd=function(){return this.getClassName()?this.getClassName():m.DEFAULTROWCLASS;};o.Jj=function(){return ub.kb+(this.getHeaderHeight()?this.getHeaderHeight():m.DEFAULTHEADERHEIGHT)+ub.lb;};o.uo=function(){return ub.D;};o.Ti=function(){var
Bb=ub.mb+this.Jj()+ub.Xa;Bb=Bb+(ub.nb+this.Jj()+ub.ob+this.Do()+ub.Sa);var
ra=this.Ld();var
...
Ia=ub.qb+this.getId()+ub.rb+this.ti()+this.Di()+this.Gd()+this.We()+ub.sb;Ia=Ia+this.doTransform();Ia=Ia+ub.hb;return Ia;};o.repaintBody=function(){var
...
Ja={};if(e)Ja.jsxrowid=e;Ja.jsxtabindex=isNaN(this.getIndex())?0:this.getIndex();Ja.jsxselectionbg=m.SELECTBGIMAGE;Ja.jsxtransparentimage=jsx3.gui.Block.SPACE;Ja.jsxid=this.getId();Ja.jsxsortpath=this.Xl();Ja.jsxsortdirection=this.getSortDirection();Ja.jsxrowclass=this.dd();Ja.jsxsorttype=this.getSortType();var
Y=this.getXSLParams();for(var Kb in Y)Ja[Kb]=Y[Kb];var
sb=this.jsxsupermix(Ja);sb=this.Nm(sb);return sb;};m.onDelete=function(f,s){var
...
Function(mb);}else if(T==ub.Mb){f.className=mb;}else if(T==ub.Nb){jsx3.gui.Painted.He(f,mb);}else f.setAttribute(T,mb);}};m.Ws=function(b,q){var
...
sa=this.getChild(Xa);if(sa instanceof jsx3.gui.Column&&sa.getSortPath()==cb)return (this.getChild(Xa)).getDataType();}return ub.Wb;}else return this.jsxsorttype;};o.setSortType=function(f){this.jsxsorttype=f;return this;};o.getMaskProperties=function(){return jsx3.gui.Block.MASK_NO_EDIT;};o.getWrap=function(){return this.jsxwrap==null?1:this.jsxwrap;};o.setWrap=function(f){this.resetXslCacheData();this.jsxwrap=f;return this;};o.onSetChild=function(i){return i instanceof jsx3.gui.Column;};o.kk=function(i){var
