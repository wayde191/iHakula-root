...
ab=null;if(h instanceof nb)ab={objEVENT:h,_gipp:1};this.doEvent(ub.n,ab);}return this;};d.setEnabled=function(h,s){if(this._jsxhotkey!=null)this._jsxhotkey.setEnabled(h==1);return this.jsxsupermix(h,s);};r.ld={};r.ld[ub.o]=ub.p;r.ld[ub.q]=true;r.ld[ub.r]=true;r.ld[ub.s]=true;r.ld[ub.t]=true;r.ld[ub.u]=true;r.ld[ub.v]=ub.w;r.ld[ub.x]=ub.y;d.gi=function(j,g,h){this.Tl(j,g,h,3);};d.Jm=function(){var
...
sb=new
jsx3.gui.Painted.Box(V);va.Td(sb);V={};if(jsx3.util.strEmpty(this.getText())){V.width=1;}else V.padding=ub.G;V.height=22;V.tagname=ub.A;V.boxtype=ub.B;var
ha=new
jsx3.gui.Painted.Box(V);va.Td(ha);V={};V.width=1;V.height=22;V.tagname=ub.A;V.boxtype=ub.B;var
zb=new
jsx3.gui.Painted.Box(V);va.Td(zb);V={};V.width=1;V.height=22;V.tagname=ub.A;V.boxtype=ub.B;var
ab=new
jsx3.gui.Painted.Box(V);va.Td(ab);return va;};d.paint=function(){this.applyDynamicProperties();var
...
fa=this.qg();var
Ha=this.Ne();var
M=null,Ja=null,wb=null;if(this.getEnabled()==1){M=this.Bf(r.ld,0);Ja=(this.getUriResolver()).resolveURI(this.getImage());wb=ub.f;}else{M=ub.f;Ja=(this.getUriResolver()).resolveURI(this.getDisabledImage());wb=jsx3.html.getCSSOpacity(0.4);}var
xb=this.renderAttributes(null,true);var
cb=this.Wl(true);cb.setAttributes(ub.J+this.getId()+ub.K+this.md()+this.Do()+this.Wb()+M+ub.L+xb);cb.setStyles(this.yg(true)+oa+fa+Ha+wb+this.Kk()+this.Vg());var
...
v;if((v=this.getText())!=null&&v!=ub.f){la.setStyles(this.Kh()+this.Gd()+this.Di()+this.We());}else{v=ub.O;la.setStyles(jsx3.html.hl);}var
