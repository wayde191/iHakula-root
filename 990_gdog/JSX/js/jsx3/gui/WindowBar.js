...
ga=this.getParent();if(ga instanceof jsx3.gui.Dialog&&ga.getRendered()!=null)ga.Mj();}return this;};f.doBeginMove=function(p,i){if(!(jsx3.html.getJSXParent(p.srcElement())).instanceOf(ub.f))(this.getParent()).doBeginMove(p,i);};a.ld={};a.ld[ub.g]=ub.h;f.gi=function(k,h,g){this.Tl(k,h,g,this.getType()==0?4:2);};f.Jm=function(s){this.applyDynamicProperties();if(this.getParent()&&(s==null||!isNaN(s.parentwidth)&&!isNaN(s.parentheight))){s=(this.getParent()).ng(this);}else if(s==null)s={};var
...
La=new
jsx3.gui.Painted.Box(Hb);kb.Td(La);}return kb;};f.paint=function(){this.applyDynamicProperties();var
Qa=this.Wl(true);var
ga=null,Za=null,v=null;if(this.getType()==0){var
_a=Qa.lg(0);_a.setAttributes(ub.o);_a.setStyles(this.Kh()+this.We()+this.Gd()+this.Di());v=(_a.paint()).join(this.ii());ga=ub.p;Za=this.Bf(a.ld,0);}else{ga=ub.q;Za=ub.r;v=ub.r;}var
da=this.renderAttributes(null,true);Qa.setAttributes(ub.s+this.getId()+ub.t+this.Wb()+this.Do()+this.md()+Za+ub.u+da);Qa.setStyles(ga+this.Ak()+this.Uc()+this.Kk()+this.ti()+this.Vg());return (Qa.paint()).join(v+this.paintChildren());};f.md=function(){return this.jsxsuper(this.getIndex()||Number(0));};f.Uc=function(){var
