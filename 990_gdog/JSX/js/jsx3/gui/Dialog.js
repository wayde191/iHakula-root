...
t=jsx3.app.Browser.isTableMoveBroken();if(Ua!=ub.x&&t)z.style.display=ub.x;this.setZIndex((this.getServer()).getNextZIndex(jsx3.app.Server.Z_DIALOG),true);if(Ua!=ub.x&&t)z.style.display=Ua;}};r.Ky=function(){var
...
Ta=this.getServer();if(Ta!=null&&Ta!=a.getServer())this.Uw(Ta);return true;};r.onSetChild=function(n){this.jsxsuper(n);if(!this.getCaptionBar()&&b.vP(n))this.clearBoxProfile(true);return true;};r.Uw=function(a){if(a==null)a=this.getServer();var
...
I=this;jsx3.gui.Interactive._beginMoveConstrained(p,i,function(m,l){return I.UH(m,l);});Ea.subscribe(ub.A,this,ub.Q);}};r.UH=function(f,e){if(b._jsxEz){this._jsxp0=f+b._jsxoffx;this._jsx_W=e+b._jsxoffy;this._jsxp0=Math.max(this._jsxp0,this.U1());this._jsx_W=Math.max(this._jsx_W,this.LG());if(typeof this.jsxmaxx==ub.O)this._jsxp0=Math.min(this._jsxp0,this.jsxmaxx);if(typeof this.jsxmaxy==ub.O)this._jsx_W=Math.min(this._jsx_W,this.jsxmaxy);var
w=(this.Wl()).lg(1);w.recalculate({width:this._jsxp0,height:this._jsx_W},b._jsxEz);return [this._jsxp0-b._jsxoffx,this._jsx_W-b._jsxoffy];}return [f,e];};r.U1=function(){var
...
H=o==this.getCaptionBar()?this.Wl(true):(this.Wl(true)).lg(0);return {parentwidth:H.Sh(),parentheight:H.Zg()};};r.mD=function(h,o){if(o&&(h.left==null||h.top==null)){var
ea=(this.getParent()).getAbsolutePosition();if(h.left==null)h.left=Math.max(0,parseInt((ea.W-h.width)/2));if(h.top==null)h.top=Math.max(0,parseInt((ea.H-h.height)/2));}this.Ul(h,true);};r.Jm=function(h){var
...
la={};la.parentwidth=Db.Sh();la.parentheight=Db.Zg();la.width=ub._;la.height=Db.Zg()-(Ia!=null?Ia.getHeight()+this.getBuffer(2):0);la.top=Ia!=null?Ia.getHeight()+this.getBuffer(2)*2:this.getBuffer(2);la.left=this.getBuffer(2);la.tagname=ub.Y;la.boxtype=ub.Z;la.border=this.getContentBorder(ub.X);var
V=new
jsx3.gui.Painted.Box(la);Db.Td(V);la={};la.left=-1;la.top=-1;la.width=this.getWidth();la.height=h.height;la.tagname=ub.Y;la.boxtype=ub.Z;la.padding=ub.aa;la.border=ub.X;var
ma=new
jsx3.gui.Painted.Box(la);Db.Td(ma);la={};la.left=this.getWidth()-(b.uJ+2);la.top=this.getHeight()-(b.uJ+2);la.width=b.uJ+1;la.height=b.uJ+1;la.tagname=ub.Y;la.boxtype=ub.Z;var
T=new
jsx3.gui.Painted.Box(la);Db.Td(T);la={};la.left=this.getWidth()-(b.uJ+2);la.top=this.getHeight()-(b.uJ+2);la.width=b.uJ;la.height=b.uJ;la.tagname=ub.Y;la.boxtype=ub.Z;var
Fb=new
jsx3.gui.Painted.Box(la);Db.Td(Fb);return Db;};r.gi=function(a,q,s){var
...
Ib=t.lg(0);var
ra=t.Zg()-(zb!=null?zb.getHeight()+this.getBuffer(2):0);Ib.recalculate({parentwidth:t.Sh(),parentheight:t.Zg(),width:ub._,height:ra},q.childNodes[1],s);var
...
za=t.lg(3);za.recalculate({top:this.getHeight()-(b.uJ+2),left:this.getWidth()-(b.uJ+2)},q.childNodes[4],s);}if(zb)s.add(zb,{width:ub._,parentwidth:t.Sh(),height:zb.getHeight()},q.childNodes[0],true);var
Z=this.getChildren();var
u=0;var
Ta=q.childNodes[zb?1:0];if(Ta){var
U=Ta.childNodes;for(var
Ba=0;Ba<Z.length;Ba++)if(Z[Ba]!=zb){s.add(Z[Ba],{parentwidth:Ib.Sh(),parentheight:Ib.Zg()},true,true);}else u=1;}}};r.paint=function(){this.applyDynamicProperties();var
Qa=this.getId();var
...
nb=[ub.ia+Qa+ub.ja+this.Wb()+this.md()+this.pi(ub.ka,ub.la,0)+ub.ma+G+this.qg()+ub.na+ub.oa+ub.pa+this.pi(ub.ea,ub.qa,1)+this.pi(ub.A,ub.ra,1)+ub.sa,ub.ta+this.md()+this.pi(ub.ka,ub.la,1)+ub.ua];t.setAttributes(Ca+this.md()+ub.va+this.dd()+ub.ja+xa);t.setStyles(ub.wa+this.Uc()+this.ti()+this.Ne()+this.Vg()+ab);}else{var
nb=[ub.w,ub.w];t.setAttributes(ub.xa+Qa+ub.ya+this.Wb()+Ca+this.md()+ub.va+this.dd()+ub.ja+xa);t.setStyles(ub.za+G+ub.Aa+this.Uc()+this.ti()+this.qg()+this.Ne()+this.Vg()+ab);}var
bb=this.getCaptionBar();var
Va=bb!=null?bb.paint():ub.Ba;var
Fb=t.lg(0);Fb.setAttributes(ub.Ca);Fb.setStyles(this.Ak()+this.Bj()+xb);var
...
L=t.lg(3);L.setStyles(ub.Ia+b.o7+ub.Ga+xb);var
...
Hb=Oa.getText();if(Hb)((_a.setText(jsx3.util.strTruncate(Hb,20))).setTip(Hb)).repaint();}}else if(_a!=null)(_a.getParent()).removeChild(_a);}};r.md=function(){return this.jsxsuper(this.getIndex()||Number(0));};r.Bj=function(){if(this.getOverflow()==2){return ub.Pa;}else return ub.Qa;};r.dd=function(){var
