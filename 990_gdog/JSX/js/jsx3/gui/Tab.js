...
y={};y.parentwidth=Jb.Sh();y.parentheight=Jb.Zg();y.height=ub.i;if(!(this.getWidth()==null||isNaN(this.getWidth()))){y.width=ub.i;y.tagname=ub.x;y.boxtype=ub.y;}else{y.tagname=ub.s;y.boxtype=ub.t;}var
G=new
jsx3.gui.Painted.Box(y);Jb.Td(G);return Jb;};d.paint=function(){if(!(this.getParent() instanceof jsx3.gui.TabbedPane)){jsx3.util.Logger.doLog(ub.z,ub.A+this.getId()+ub.B);return ub.u;}this.applyDynamicProperties();var
y=this.getEnabled()==1?this.Bf(p.ld,0):ub.u;var
ea=this.renderAttributes(null,true);var
_=this.Wl(true);_.setAttributes(ub.C+this.getId()+ub.D+this.Wb()+this.md()+this.Do()+y+ub.E+ea);_.setStyles(this.ji()+this.yg()+this.Uc()+this.Kh()+this.Gd()+this.Di()+this.We()+this.Ak()+this.Ne()+this.Vg());var
La=_.lg(0);La.setAttributes(ub.F+jsx3.html.pe);La.setStyles(this.Ak());return (_.paint()).join((La.paint()).join(this.ii()));};d.setWidth=function(f,j){this.jsxsuper(f);if(j)this.repaint();};d.setText=function(k,b){this.jsxsuper(k,b);if(b&&this.getParent())(this.getParent()).Zf();};d.ji=function(){return ub.G+p.INACTIVEBEVEL+ub.H;};d.yg=function(){return this.getEnabled()==1?ub.I:ub.u;};d.md=function(){return this.jsxsuper(this.getIndex()||Number(0));};d.kh=function(){return this.getActiveColor()?this.getActiveColor():p.DEFAULTACTIVECOLOR;};d.Al=function(){return this.getInactiveColor()?this.getInactiveColor():p.DEFAULTINACTIVECOLOR;};d.Uc=function(){var
Xa=this.getChildIndex()!=(this.getParent()).getSelectedIndex()?this.Al():this.kh();return Xa?ub.J+Xa+ub.K:ub.u;};p.getVersion=function(){return ub.L;};d.getContentChild=function(){return this.getChild(0);};d.qd=function(b){var
ia=this.getContentChild();if(ia)ia.qd(b);this.jsxsuper(b);};});jsx3.Tab=jsx3.gui.Tab;
