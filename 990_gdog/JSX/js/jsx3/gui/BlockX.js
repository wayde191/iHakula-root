...
ub={a:"loading",b:"error",c:"xml.err_load_xsl",d:"jsx3.gui.BlockX.",e:"jsxdisableescape",f:"bB",g:"3.00.00"};g.init=function(n,k,f,l,i){this.jsxsuper(n,k,f,l,i);};g.paint=function(){this.applyDynamicProperties();if(this.jsxxslasync){var
Ta=this.getXSL();if(!Ta.hasError()&&Ta.getNamespaceURI()==jsx3.app.Cache.XSDNS){var
Da=Ta.getNodeName();if(Da==ub.a)this.FI(true);else if(Da==ub.b)(jsx3.util.Logger.getLogger(a.jsxclass.getName())).error(jsx3._msg(ub.c,this,Ta.getAttribute(ub.b)));return this.jsxsuper(this._getLocaleProp(ub.d+Ta.getNodeName()));}}return this.jsxsuper(this.doTransform());};g.onAfterPaint=function(n){var
...
A=C.getCache();var
v=this.getXSLId();if(m)A.subscribe(v,this,ub.f);else A.unsubscribe(v,this);this._jsxxslbound=m;}}};g.bB=function(s){this.FI(false);this.repaint();};g.getXSL=function(){var
