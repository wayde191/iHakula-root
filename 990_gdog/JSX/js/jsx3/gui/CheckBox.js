...
Ja=new
jsx3.gui.Painted.Box(ca);K.Td(Ja);var
ca={};ca.tagname=ub.i;ca.boxtype=ub.k;ca.width=16;ca.parentheight=K.Zg();ca.height=18;ca.left=0;ca.top=0;var
Sa=new
jsx3.gui.Painted.Box(ca);Ja.Td(Sa);var
ca={};ca.tagname=ub.n;ca.empty=true;ca.omitpos=true;var
qb=new
jsx3.gui.Painted.Box(ca);Sa.Td(qb);var
ca={};ca.tagname=ub.i;ca.boxtype=ub.k;ca.left=3;ca.top=7;ca.width=7;ca.height=2;var
v=new
jsx3.gui.Painted.Box(ca);Sa.Td(v);var
ca={};ca.tagname=ub.i;ca.boxtype=ub.m;ca.top=2;ca.parentheight=K.Zg();ca.height=18;ca.padding=ub.o;var
wb=new
jsx3.gui.Painted.Box(ca);K.Td(wb);return K;};f.focus=function(b){if(!b)b=this.getRendered();if(b)jsx3.html.focus(jsx3.html.selectSingleElm(b,ub.p));};f.paint=function(){this.applyDynamicProperties();var
da=this.getEnabled()==1;var
nb=da?this.Bf(n.ld,0):ub.d;var
Da=this.renderAttributes(null,true);var
kb=this.getChecked()==2?ub.e:ub.f;var
Hb=da?ub.d:ub.q;var
Ja=this.Wl(true);Ja.setAttributes(ub.r+this.getId()+ub.s+this.Wb()+ub.t+this.dd()+ub.s+this.Do()+this.Wn()+nb+Da);Ja.setStyles((Ja.getPaintedWidth()?ub.u:ub.d)+this.yg(true)+this.Gd()+this.Di()+this.We()+this.Kh()+this.Uc()+this.qg()+this.Ne()+this.Kk()+this.Vg());var
pb=Ja.lg(0);var
gb=pb.lg(0);gb.setAttributes(ub.v);var
Ba=gb.lg(0);Ba.setAttributes(ub.w+this.getName()+ub.x+this.Wn()+this._W()+this.md());var
sa=gb.lg(1);sa.setAttributes(ub.y);sa.setStyles(ub.z+kb+ub.A+Hb);var
Fa=Ja.lg(1);Fa.setAttributes(jsx3.html.pe);return (Ja.paint()).join((pb.paint()).join((gb.paint()).join((Ba.paint()).join(ub.d)+(sa.paint()).join(ub.B))+(Fa.paint()).join(this.ii())));};f._W=function(){return this.getChecked()==1?ub.C:ub.d;};f.dd=function(){var
