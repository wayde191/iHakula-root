...
tb=[g,e,l];var
y=jsx3.ZN;y[y.length]=tb;jsx3.I9[e]=tb;if(jsx3.PU==null)jsx3.PU=window.setTimeout(jsx3.PM,0);};jsx3.QUEUE_DONE=ub.o;jsx3.PM=function(){jsx3.util.WeakMap.expire();jsx3.tcf(function(){var
la=jsx3.ZN;jsx3.ZN=[];for(var
ob=0;ob<la.length;ob++){var
T=la[ob];var
sb=T[0];if(!sb)continue;var
M=T[1];var
da=T[2];delete jsx3.I9[M];sb.apply(da);}},null,function(){if(jsx3.ZN.length>0)jsx3.PU=window.setTimeout(jsx3.PM,0);else{jsx3.PU=null;jsx3.publish({subject:jsx3.QUEUE_DONE});}});};jsx3.startup=function(){if(window.OpenAjax)try{OpenAjax.hub.registerLibrary(ub.p,ub.q,jsx3.getVersion());}catch(Kb){var
x=jsx3.util.Logger;if(x)x.GLOBAL.error(jsx3._msg(ub.r),jsx3.NativeError.wrap(Kb));}};jsx3.destroy=function(){if(jsx3.app&&jsx3.app.Server){var
F=jsx3.app.Server.allServers();for(var
Sa=0;Sa<F.length;Sa++)try{F[Sa].destroy();}catch(Kb){}}if(jsx3.gui&&jsx3.gui.Event){var
Ya="BEFOREUNLOAD BLUR CHANGE CLICK DOUBLECLICK ERROR FOCUS KEYDOWN KEYPRESS KEYUP LOAD MOUSEDOWN MOUSEMOVE MOUSEOUT MOUSEOVER MOUSEUP MOUSEWHEEL UNLOAD RESIZE".split(ub.s);for(var
Sa=0;Sa<Ya.length;Sa++)jsx3.gui.Event.unsubscribeAll(jsx3.gui.Event[Ya[Sa]]);}jsx3.NativeError.stopErrorCapture();var
ma=document.getElementsByTagName(ub.t);for(var
Sa=0;Sa<ma.length;Sa++){var
B=ma.item(Sa);B.parentNode.removeChild(B);}jsx3.CLASS_LOADER.destroy();window.jsx3=null;};jsx3.getClass=function(g){try{var
pb=eval(g);return typeof pb==ub.u?pb:null;}catch(Kb){return null;}};jsx3.Gk=function(k){try{var
wb=eval(k+ub.v);return typeof wb==ub.l&&typeof wb.constructor==ub.u?wb:null;}catch(Kb){return null;}};jsx3.getClassConstants=function(d){var
S=jsx3.getClass(d);if(S!=null){var
Fb=[];for(var ta in S)if(ta.toUpperCase()==ta)Fb[Fb.length]=d+ub.w+ta;return Fb;}};jsx3.getInstanceMethods=function(r){var
Va=jsx3.Gk(r);var
vb=[];for(var jb in Va)if(typeof Va[jb]==ub.u){var
u=Va[jb].toString();vb[vb.length]=u.substring(9,u.indexOf(ub.x)+1);}return vb;};jsx3.getClassMethods=function(f){var
B=jsx3.getClass(f);var
ka=ub.g;for(var Ja in B)if(typeof B[Ja]==ub.u){var
Bb=B[Ja].toString();ka=ka+(Ja+Bb.substring(8,Bb.indexOf(ub.x)+1)+ub.y);}return ka;};jsx3.doInherit=function(r,g,p){var
Y=jsx3.getClass(r);var
Jb=jsx3.getClass(g);if(Jb==null){jsx3.util.Logger.doLog(ub.z,ub.A+g+ub.B+r+ub.C,1,false);return;}if(Y.isInherited==null||p!=null&&p){if(!p){Y.SUPER=g;Y.SUPERS={};for(var zb in Jb.SUPERS){Y.SUPERS[zb]=Jb.SUPERS[zb];Y.SUPERS[r]=1;}}Y.className=r;if(Y.INHERITANCE==null)Y.INHERITANCE=[r];if(Jb.INHERITANCE)for(var
I=Jb.INHERITANCE.length-1;I>=0;I--)Y.INHERITANCE.splice(1,0,Jb.INHERITANCE[I]);else Y.INHERITANCE.splice(1,0,g);if(Y.INTERFACES==null)Y.INTERFACES={};if(Jb.INTERFACES){for(var zb in Jb.INTERFACES)Y.INTERFACES[zb]=Jb.INTERFACES[zb];}else Y.INTERFACES[g]=ub.D;Y.INTERFACES[r]=ub.D;if(!(p!=null&&p))Y.isInherited=true;var
ga=jsx3.Gk(g);var
ib=jsx3.Gk(r);for(var zb in ga)if(typeof ib[zb]!=ub.u)ib[zb]=ga[zb];}};jsx3.doImplement=function(h,p){jsx3.doInherit(h,p,true);};jsx3.doMixin=function(p,b){var
Xa=jsx3.Gk(b);for(var vb in Xa)if(typeof Xa[vb]==ub.u)p[vb]=Xa[vb];};jsx3.doDefine=function(c,r){var
Ya=jsx3.getClass(c);if(Ya.isDefined==null){Ya.isDefined=true;r();}};jsx3.out=function(q,c,j,k){if(jsx3.Class.forName(ub.E))jsx3.util.Logger.doLog(q,c,j,k);};window.doInherit=jsx3.doInherit;window.doImplement=jsx3.doImplement;window.doMixin=jsx3.doMixin;window.doDefine=jsx3.doDefine;jsx3.log=function(c){if(jsx3.Class.forName(ub.E)&&jsx3.util.Logger.GLOBAL){if(jsx3.GP){for(var
Ea=0;Ea<jsx3.GP.length;Ea++)jsx3.util.Logger.GLOBAL.info(jsx3.GP[Ea]);delete jsx3[ub.F];}jsx3.util.Logger.GLOBAL.info(c);}else{var
za=jsx3.GP;if(!za)jsx3.GP=za=[];za[za.length]=c;}};});jsx3.Package.definePackage("jsx3.app",function(){});jsx3.Boolean={};jsx3.Boolean.TRUE=1;jsx3.Boolean.FALSE=0;jsx3.Boolean.valueOf=function(o){return o?1:0;};jsx3.Package.definePackage("jsx3.gui",function(p){var
ub={a:"className"};p.Cc=function(o,k){var
I=[];for(var
Da=0;Da<arguments.length-1;Da=Da+2){o=arguments[Da];if(o._jsxRr)continue;o._jsxRr=true;k=arguments[Da+1];var
ga={};for(var Eb in k)ga[Eb]=Eb==ub.a?o.className:o.style[Eb];I.push(o,ga,k);}p.iL(I,0,6);};p.iL=function(o,a,n){if(a==n){for(var
B=0;B<o.length-2;B=B+3){var
Aa=o[B];Aa._jsxRr=null;}return;}for(var
B=0;B<o.length-2;B=B+3){var
Aa=o[B];var
P=a%2==0?o[B+2]:o[B+1];for(var Eb in P)if(Eb==ub.a)Aa.className=P[Eb];else Aa.style[Eb]=P[Eb];}window.setTimeout(function(){p.iL(o,a+1,n);},75);};p.isMouseEventModKey=function(r){if(jsx3.app.Browser.macosx)return r.metaKey();else return r.ctrlKey();};});jsx3.Package.definePackage("jsx3.lang",function(p){});jsx3.Package.definePackage("jsx3.net",function(d){});jsx3.Class.defineInterface("jsx3.net.URIResolver",null,function(f,m){var
ub={a:"jsxabspath",b:"jsxhomepath",c:"jsxscriptapppath",d:"..",e:"jsx",f:"JSX",g:"/",h:"jsxuser",i:"JSXAPPS",j:"GI_Builder/",k:"function",l:"jsxurirslv",m:"3.6",n:"strURI",o:"bRel"};f.xq={};f.register=function(e,s){f.xq[e]=s;};f.As=function(){if(this.V0==null)this.V0=new
...
jsx3.net.URI(t);return this.vr;};f.DEFAULT=f.jsxclass.newInnerClass();f.DEFAULT.resolveURI=function(a){var
tb=jsx3.net.URI.valueOf(a);var
Z=tb.getScheme();var
Pa=tb.getPath();var
_a=f.getResolver(tb);var
Sa=tb;if(_a&&_a!=f.DEFAULT){if(tb.isAbsolute())tb=jsx3.net.URI.fromParts(null,null,null,null,Pa.substring(1),tb.getQuery(),tb.getFragment());Sa=_a.resolveURI(tb);}else if(_a){Sa=(f.As()).resolve(tb);}else if(!Z&&Pa.indexOf(ub.d)>=0){var
_=jsx3.app.Browser.getLocation();Sa=_.relativize(_.resolve(tb));}return Sa;};f.DEFAULT.getUriPrefix=function(){return (f.As()).toString();};f.DEFAULT.relativizeURI=function(h,o){return jsx3.net.URI.valueOf(h);};f.JSX=f.jsxclass.newInnerClass();f.register(ub.e,f.JSX);f.JSX.getURI=function(){if(this._uri==null)this._uri=(f.As()).resolve(ub.f+ub.g);return this._uri;};f.JSX.resolveURI=function(h){var
Lb=jsx3.net.URI.valueOf(h);if(!f.isAbsoluteURI(Lb))Lb=(this.getURI()).resolve(Lb);return f.DEFAULT.resolveURI(Lb);};f.JSX.getUriPrefix=function(){return f.As()+ub.f+ub.g;};f.JSX.relativizeURI=function(h,o){var
pb=(this.getURI()).relativize(h);if(pb.isAbsolute()||o)return pb;else return jsx3.net.URI.fromParts(ub.e,null,null,null,ub.g+pb.getPath(),pb.getQuery(),pb.getFragment());};f.USER=f.jsxclass.newInnerClass();f.register(ub.h,f.USER);f.USER.resolveURI=function(j){var
Ab=jsx3.net.URI.valueOf(j);if((Ab.getPath()).indexOf(ub.i+ub.g)==0||!f.isAbsoluteURI(Ab))return (f.Qs()).resolve(Ab);return f.DEFAULT.resolveURI(Ab);};f.USER.getUriPrefix=function(){return (f.Qs()).toString();};f.USER.relativizeURI=function(r,k){var
pa=jsx3.app.Browser.getLocation();var
La=(pa.resolve(jsx3.getEnv(ub.b))).relativize(pa.resolve(r));if(La.isAbsolute()||k)return La;else return jsx3.net.URI.fromParts(ub.h,null,null,null,ub.g+La.getPath(),La.getQuery(),La.getFragment());};f.isAbsoluteURI=function(g){var
Cb=jsx3.net.URI.valueOf(g);if(Cb.getScheme()!=null)return true;var
nb=Cb.getPath();return nb.indexOf(ub.g)==0||nb.indexOf(ub.f+ub.g)==0||nb.indexOf(ub.i+ub.g)==0||nb.indexOf(ub.j)==0;};f.getResolver=function(j){var
Aa=jsx3.net.URI.valueOf(j);var
B=Aa.getScheme();var
Sa=null;if(B){Sa=f.xq[B];if(typeof Sa==ub.k)Sa=Sa(Aa);}else{var
Ya=Aa.getPath();if(Ya.indexOf(ub.f+ub.g)==0||Ya.indexOf(ub.j)==0)Sa=f.DEFAULT;else if(jsx3.getEnv(ub.l)==ub.m&&Ya.indexOf(ub.i+ub.g)==0)Sa=f.USER;}return Sa;};m.resolveURI=jsx3.Method.newAbstract(ub.n);m.getUriPrefix=jsx3.Method.newAbstract();m.relativizeURI=jsx3.Method.newAbstract(ub.n,ub.o);});jsx3.Package.definePackage("jsx3.xml",function(r){});jsx3.Package.definePackage("jsx3.util",function(c){var
...
k(window.event,n):null;};a._event=function(){if(this.iv==null)return this._clone;else return this.iv;};a.event=function(){return this._event();};a.getType=function(){return (this._event()).type;};a.srcElement=function(){var
...
Gb=this._event();Gb._jsxC5=true;if(!Gb._jsxcD)Gb.stopPropagation();};a.cancelReturn=function(){(this._event()).returnValue=false;};a.cancelKey=function(){var
ab=this._event();if(!ab._jsxcD){ab.stopPropagation();ab.preventDefault();}};a.cancelAll=function(){this.cancelBubble();this.cancelKey();this.cancelReturn();};a.leftButton=function(){var
...
Ua=o.bW;if(!jsx3.util.strEmpty(o.getPrefix()))this.setAttribute(ub.d+o.getPrefix(),o.getNamespaceURI());var
...
t=this.bW.namespaceURI;if(t==null)t=ub.e;return t;};a.selectSingleNode=function(l,s){if(!this.bW)return null;return this.jl(l,s,0);};a.selectNodes=function(s,l){if(!this.bW)return new
...
bb=za.indexOf(ub.f);return bb>=0?za.substring(0,bb):ub.e;};a.getXML=function(){return this.toString();};a.toString=function(){var
...
pb=this.bW.childNodes[fa];if(pb.nodeType==3||pb.nodeType==4)v[fa]=pb.nodeValue;else v[fa]=pb.textContent;}return v.join(ub.e);}else return this.bW.nodeValue;};a.setValue=function(d){if(d==null)d=ub.e;if(this.Nt==1){this.removeChildren();this.appendChild(this.createNode(3,d));}else this.bW.nodeValue=d;return this;};m.VY=new
XPathEvaluator();m.LH=[XPathResult.FIRST_ORDERED_NODE_TYPE,XPathResult.ORDERED_NODE_ITERATOR_TYPE,XPathResult.ORDERED_NODE_SNAPSHOT_TYPE];a.jl=function(p,o,e){if(typeof o==ub.l)o=jsx3.xml.Document.sc(o);var
Ca=this.bW.ownerDocument;var
M=Ca.documentElement;var
bb=o?m.gs(o,M):m.g4(Ca)||m.VY.createNSResolver(M);var
sa=null;try{sa=m.VY.evaluate(p,this.bW,bb,m.LH[e],null);}catch(Kb){}if(e==1){var
nb=null;var
...
m(sa.singleNodeValue):null;};m.g4=function(g){if(!g._jsxoi)if(g._jsxdf)g._jsxoi=m.gs(g._jsxdf);return g._jsxoi;};m.z1={};m.gs=function(q){var
wb=m.z1[q];if(!wb){var
Ia=(new
DOMParser()).parseFromString(ub.m+q+ub.n,ub.o);wb=m.z1[q]=m.VY.createNSResolver(Ia.documentElement);}return wb;};a.Kt=function(e){if(e==null){return this.bW.ownerDocument;}else if(e==1){var
...
tb=new
jsx3.xml.Template(k);if(i)tb.setParams(i);return tb[g?ub.q:ub.r](this);};m.hw=function(){};m.hw.prototype.toString=function(){return ub.s+this.code+ub.t+(typeof this.description!=ub.u?ub.v+this.description:ub.e);};a.Wd=function(i,c){if(this._x==null)this._x=new
m.hw();this._x.code=i;this._x.description=c;};a.getError=function(){if(!this._x)this.Wd(0);return this._x;};a.hasError=function(){return this._x!=null&&this._x.code!=0;};a.getOwnerDocument=function(){return this.bW?new
...
nb=jsx3.Exception;q.init=function(r){this.jsxsuper(null,true);this.sl=r;};q.get=function(b){var
_a=this.sl[b];return _a!=null?new
...
k(arguments.length>1?this.sl.slice(a,h):this.sl.slice(a));};q.toString=function(){return ub.b+this.toArray()+ub.c;};q.clone=function(){return new
k(this.sl.concat());};q.toArray=function(){var
ua=this.size();var
W=new
Array(ua);for(var
pa=0;pa<ua;pa++)W[pa]=this.get(pa);return W;};});jsx3.Class.defineClass("jsx3.xml.Entity.ChildIterator",null,[jsx3.util.Iterator],function(e,i){i.init=function(q,k){this.ox=q;this.dE=0;this.uL=k;this.o6();this.bW=null;};i.next=function(){if(!this._next)return null;if(this.bW){this.bW.init(this._next);}else this.bW=new
jsx3.xml.Entity(this._next);this.o6();return this.bW;};i.hasNext=function(){return this._next!=null;};i.o6=function(){this._next=null;var
O=this.ox;var
hb=O.length;while(this._next==null&&this.dE<hb){var
Cb=O[this.dE];if(Cb.nodeType==1||this.uL&&(Cb.nodeType==3||Cb.nodeType==4))this._next=Cb;this.dE++;}};});jsx3.Class.defineClass("jsx3.xml.Entity.SelectIterator",null,[jsx3.util.Iterator],function(i,m){m.init=function(g){this.BA=g;this.sI=0;this.bW=null;};m.next=function(){var
y=this.BA.snapshotItem(this.sI++);if(!y)return null;if(this.bW){this.bW.init(y);}else this.bW=new
jsx3.xml.Entity(y);return this.bW;};m.hasNext=function(){return this.BA&&this.sI<this.BA.snapshotLength;};});jsx3.Collection=jsx3.xml.Entity.List;jsx3.util.Collection=jsx3.Collection;jsx3.Class.defineClass("jsx3.net.Request",null,[jsx3.util.EventDispatcher],function(g,f){var
...
Ea=new
jsx3.xml.Document();Ea.Gn(this);if(!Ea.hasError()){return Ea;}else{g.m9(2,jsx3._msg(ub.e,this.kC,Ea.getError()));return null;}};f.getNative=function(){return this._request;};f.setRequestHeader=function(b,m){this._request.setRequestHeader(b,String(m));return this;};f.getReadyState=function(){return this._request.readyState;};g.open=function(n,l,r,s,e){var
_=jsx3.net.URI.valueOf(l);var
lb=_.getScheme();var
Lb=g._HANDLERS[lb]||g.jsxclass;return (Lb.newInstance()).open(n,_,r,s,e);};g._HANDLERS={};g.addSchemeHandler=function(q,p){g._HANDLERS[q]=p;};g.getSchemeHandler=function(k){return g._HANDLERS[k];};f.open=function(l,j,a,b,p){this.hS=0;this.F8=Boolean(a);this.Zq=l;this.kC=jsx3.net.URIResolver.DEFAULT.resolveURI(j);try{if(window.netscape&&netscape.security)netscape.security.PrivilegeManager.enablePrivilege(ub.f);}catch(Kb){g.m9(5,jsx3._msg(ub.g,jsx3.NativeError.wrap(Kb)));}try{g.m9(6,jsx3._msg(ub.h,this.kC));this._request.open(l,this.kC.toString(),this.F8,b,p);}catch(Kb){this.hS=400;g.m9(2,jsx3._msg(ub.i,j,jsx3.NativeError.wrap(Kb)));}return this;};g.cancelRequest=function(q){var
I=g.uV[q];if(I)I.abort();};g.getRequest=function(p){return g.uV[p];};f.getURL=function(){return this.kC&&this.kC.toString();};f.setTimeouts=function(o,j,e,m){return this;};f.send=function(a,p){if(this.hS==400)throw new
jsx3.Exception(jsx3._msg(ub.j));var
Za=new
jsx3.util.Timer(g.jsxclass,this.kC);var
qa=false;try{this._request.send(a);if(this.F8)this.hS=0;else delete this[ub.k];}catch(Kb){this.hS=400;g.m9(2,jsx3._msg(ub.l,this.kC,jsx3.NativeError.wrap(Kb)));qa=this;}if(this.F8){if(qa||this._request.readyState==4){jsx3.sleep(function(){Za.log(ub.m);this.publish({subject:ub.a});},null,this);}else{var
sa=this;this._request.onreadystatechange=function(){if(sa._request.readyState==4){Za.log(ub.m);sa.WM();}};this._request.onerror=(jsx3.$F(this.s7)).bind(this);if(!isNaN(p)&&p>0)this._timeoutto=window.setTimeout(function(){Za.log(ub.b);sa.A9();},p);}}else Za.log(ub.n);return this;};f.A9=function(){delete this[ub.d];this.abort();this.hS=408;this.publish({subject:ub.b});};f.WM=function(){delete this[ub.k];if(this._timeoutto){window.clearTimeout(this._timeoutto);delete this[ub.d];}this._request.onreadystatechange=new
...
w=h.documentElement;if(w==null){if(o)this.Wd(156,jsx3._msg(ub.u,o));else this.Wd(106,jsx3._msg(ub.v));return true;}else{var
wb=new
XPathEvaluator();var
...
kb=this.MV.createProcessingInstruction(n,q);this.MV.appendChild(kb);};m.setAsync=function(h){this._jsxPD=h;return this;};m.getAsync=function(b){return Boolean(this._jsxPD);};m.setSelectionLanguage=function(k){return this;};m.getSelectionLanguage=function(){return ub.Q;};e.sc=function(n){var
Ca=[];for(var M in n)Ca[Ca.length]=ub.R+n[M]+ub.S+M+ub.T;return Ca.join(ub.B);};m.setSelectionNamespaces=function(b){if(typeof b==ub.U)b=e.sc(b);this.MV._jsxdf=b;this.MV._jsxoi=null;return this;};m.getSelectionNamespaces=function(b){return this.MV._jsxdf?this.MV._jsxdf:ub.g;};m.createNamespaceAxis=function(){var
mb=this.getRootNode();var
Wa=mb.toString();var
P=ub.g;do{var
ma=new
RegExp(ub.R+ub.e+P+ub.V,ub.W);var
L=Wa.search(ma);if(L>=0)P=P==ub.g?0:P+1;}while(L>=0);this.XK(mb,ub.e+P);this.loadXML(this.getXML());return ub.e+P;};m.XK=function(l,g){var
...
Ta=l.getChildIterator();Ta.hasNext();)this.XK(Ta.next(),g);};m.getDeclaredNamespaces=function(a){this._jsxqH={};var
v=this.getRootNode();if(v)this.KF(v,{index:0},a);return this._jsxqH;};m.KF=function(h,d,l){var
Sa=h.getNamespaceURI();if(Sa!=ub.g&&Sa!=ub.Y){var
ra;if(!this._jsxqH[Sa]||l&&(ra=h.getPrefix())!=ub.g&&typeof l[ra]!=ub.Z)if(ra){this._jsxqH[Sa]=ra;}else{d.index+=1;this._jsxqH[Sa]=ub._+d.index;}}if(h.getNodeType()==1)for(var
Bb=h.selectNodeIterator(ub.aa);Bb.hasNext();){var
eb=Bb.next();if(eb.getNodeType()==1||eb.getNodeType()==2)this.KF(eb,d,l);}};m.getNativeDocument=function(){return this.MV;};e.m9=function(f,j){if(e.KD==null)if(jsx3.util.Logger){e.KD=jsx3.util.Logger.getLogger(e.jsxclass.getName());if(e.KD==null)return;}else return;e.KD.log(f,j);};e.getVersion=function(){return ub.ba;};});jsx3.Document=jsx3.xml.Document;jsx3.Class.defineClass("jsx3.xml.Template",null,null,function(p,s){var
...
ub={A:"<",B:' xmlns="',C:'"',D:" ",E:'="',F:"/>",G:">",H:"</",I:"<![CDATA[",J:"]]>",K:"&",L:";",M:"<!--",N:"-->",O:"html.set_outer",P:"beforeend",Q:"beforebegin",R:"html.adj",S:"opacity:",T:"text",U:"jsx:///images/icons/h.png",V:"jsx:///images/icons/v.png",W:"background-image:url(",X:");",Y:"_jsx_",Z:"disable-output-escp",_:/&lt;/g,a:"",aa:/&gt;/g,b:"overflow:hidden;font-size:0px;",ba:/&quot;/g,c:"body",ca:/&amp;/g,d:'<input type="text" id="_jsx3_html_b1" style="position:absolute;top:0px;left:-120px;width:100px;height:30px;padding:8px;margin:0px;"/>',da:/&([a-zA-Z_]+);/g,e:"beforeEnd",ea:"class",f:"_jsx3_html_b1",fa:/<span class=\"disable-output-escp\">([\s\S]*?)<\/span>/g,g:'<div id="_jsx3_html_b2" style="position:absolute;top:0px;left:-116px;width:100px;height:24px;padding:8px;"></div>',ga:"&#",h:"_jsx3_html_b2",ha:"jsx_image_loader",i:"string",ia:"none",j:/^<([^\s]*)([\s\S]*)\/>$/i,ja:"_",k:"<$1$2></$1>",ka:"img",l:/^on/,la:"id",m:"function",ma:"src",n:"event",na:"unshift",o:"head",oa:"push",p:"undefined",pa:/\//g,q:"http://www.w3.org/1999/xhtml",qa:" A AREA BUTTON INPUT OBJECT SELECT TEXTAREA ",r:"style",ra:"focus",s:" {",sa:/\s+/g,t:"}",u:"type",v:"text/css",w:"media",x:"screen",y:"span",z:"div"};var
...
W=P.getElementById(ub.h);if(parseInt(W.offsetWidth)>100)r.XE=1;pa.removeChild(W);}pa.removeChild(wa);}return r.XE;};r.emptyToClosed=function(c){return typeof c==ub.i?c.replace(ub.j,ub.k):c;};r.restoreScrollPosition=function(i){};r.persistScrollPosition=function(i){};r.getScrollSizeOffset=function(l,g){return 0;};r.addEventListener=function(c,m,f){m=m.replace(ub.l,ub.a);c.addEventListener(m,typeof f==ub.m?f:new
Function(ub.n,f),false);};r.removeEventListener=function(i,g,l){g=g.replace(ub.l,ub.a);i.removeEventListener(g,l,false);};r.removeStyle=function(g,i){g.style.removeProperty(i);};r._FOCUSABLE={input:true,textarea:true,select:true,body:true,a:true,img:true,button:true,frame:true,iframe:true,object:true};r.isFocusable=function(k){return k.focus!=null&&(parseInt(k.tabIndex)>=0||r._FOCUSABLE[k.tagName.toLowerCase()]);};r.createRule=function(s,k,h){if(!h)h=document;var
T=(h.getElementsByTagName(ub.o))[0];var
ha=typeof h.createElementNS!=ub.p?h.createElementNS(ub.q,ub.r):h.createElement(ub.r);var
tb=h.createTextNode(s+ub.s+k+ub.t);ha.appendChild(tb);ha.setAttribute(ub.u,ub.v);ha.setAttribute(ub.w,ub.x);T.appendChild(ha);};r.getRuleByName=function(i){var
Ya=document.styleSheets;for(var
wb=0;wb<Ya.length;wb++){var
R=Ya[wb];for(var
Lb=0;Lb<R.cssRules.length;Lb++)if(R.cssRules[Lb].selectorText==i)return R.cssRules[Lb];}return null;};r.scrollIntoView=function(o,q,d,c){var
qb=o.parentNode;while(qb!=null){var
Da=qb.tagName.toLowerCase();if(Da==ub.y||Da==ub.z){var
ua=r.getRelativePosition(qb,o);if(qb.clientWidth+qb.scrollLeft<=ua.L){qb.scrollLeft=ua.L+o.offsetWidth-qb.clientWidth+d;}else if(qb.clientWidth+qb.scrollLeft<ua.L+o.offsetWidth&&d!=null)qb.scrollLeft=ua.L+o.offsetWidth-qb.clientWidth+d;if(qb.scrollLeft>=ua.L+o.offsetWidth){qb.scrollLeft=ua.L-d;}else if(qb.scrollLeft>ua.L&&d!=null)qb.scrollLeft=ua.L-d;if(qb.clientHeight+qb.scrollTop<=ua.T){qb.scrollTop=ua.T+o.offsetHeight-qb.clientHeight+c;}else if(qb.clientHeight+qb.scrollTop<ua.T+o.offsetHeight&&c!=null)qb.scrollTop=ua.T+o.offsetHeight-qb.clientHeight+c;if(qb.scrollTop>=ua.T+o.offsetHeight){qb.scrollTop=ua.T-c;}else if(qb.scrollTop>ua.T&&c!=null)qb.scrollTop=ua.T-c;}if(qb==q)break;qb=qb.parentNode;}};r.getOuterHTML=function(o){if(window.SVGElement&&o instanceof SVGElement){return (new
XMLSerializer()).serializeToString(o);}else{var
Ea=[];switch(o.nodeType){case 1:Ea[Ea.length]=ub.A+o.nodeName.toLowerCase();if(o.namespaceURI)Ea[Ea.length]=ub.B+o.namespaceURI+ub.C;for(var
B=0;B<o.attributes.length;B++){var
N=o.attributes.item(B);if(N.nodeValue!=null)Ea[Ea.length]=ub.D+N.nodeName+ub.E+N.nodeValue+ub.C;}if(o.childNodes.length==0)Ea[Ea.length]=ub.F;else Ea[Ea.length]=ub.G+o.innerHTML+ub.H+o.nodeName.toLowerCase()+ub.G;break;case 3:Ea[Ea.length]=o.nodeValue;break;case 4:Ea[Ea.length]=ub.I+o.nodeValue+ub.J;break;case 5:Ea[Ea.length]=ub.K+o.nodeName+ub.L;break;case 8:Ea[Ea.length]=ub.M+o.nodeValue+ub.N;break;default:if(o.childNodes)for(var
rb=0;rb<o.childNodes.length;rb++)Ea.push(r.getOuterHTML(o.childNodes[rb]));break;}return Ea.join(ub.a);}};r.setOuterHTML=function(d,j){if(window.SVGElement&&d instanceof SVGElement){if(!j){d.parentNode.removeChild(d);}else{var
H=d.ownerDocument.createRange();H.setStartBefore(d);var
ga=H.createContextualFragment(j);d.parentNode.replaceChild(ga,d);}}else try{var
H=d.ownerDocument.createRange();H.setStartBefore(d);var
ga=H.createContextualFragment(j);d.parentNode.replaceChild(ga,d);}catch(Kb){var
Z=typeof j==ub.i?j.substring(0,50):j;throw new
jsx3.Exception(jsx3._msg(ub.O,d,Z),jsx3.NativeError.wrap(Kb));}};r.removeNode=function(p){p.parentNode.removeChild(p);};r.setInnerText=function(f,g){for(var
zb=f.childNodes.length-1;zb>=0;zb--)f.removeChild(f.childNodes[zb]);f.appendChild(f.ownerDocument.createTextNode(g));};r.insertAdjacentHTML=function(k,p,c){if(p.toLowerCase()==ub.P){var
Q=k.ownerDocument.createRange();Q.setStartAfter(k);var
Ca=Q.createContextualFragment(c);k.appendChild(Ca);return c;}else if(p.toLowerCase()==ub.Q){var
Q=k.ownerDocument.createRange();Q.setStartBefore(k);var
Ca=Q.createContextualFragment(c);k.parentNode.insertBefore(Ca,k);return c;}else throw new
jsx3.Exception(jsx3._msg(ub.R,p));};r.updateCSSOpacity=function(b,h){b.style.opacity=h.toString();};r.getCSSOpacity=function(q){return ub.S+q+ub.L;};r.getRelativePosition=function(d,i){var
jb={W:i.offsetWidth,H:i.offsetHeight};var
t=i.scrollLeft;var
D=i.scrollTop;var
aa=0;var
y=0;var
...
S=0;var
ea=0;var
Mb;if(i.offsetParent){ea=ea-i.offsetParent.scrollLeft;S=S-i.offsetParent.scrollTop;Mb=i.offsetParent.style.borderLeftWidth?parseInt(i.offsetParent.style.borderLeftWidth):0;if(!isNaN(Mb))aa=aa+Mb;Mb=i.offsetParent.style.borderTopWidth?parseInt(i.offsetParent.style.borderTopWidth):0;if(!isNaN(Mb))y=y+Mb;}while((i=i.offsetParent)!=null&&i!=d){fa=fa+i.offsetTop;eb=eb+i.offsetLeft;if(i.offsetParent){Mb=i.offsetParent.style.borderLeftWidth?parseInt(i.offsetParent.style.borderLeftWidth):0;if(!isNaN(Mb))aa=aa+Mb;Mb=i.offsetParent.style.borderTopWidth?parseInt(i.offsetParent.style.borderTopWidth):0;if(!isNaN(Mb))y=y+Mb;ea=ea+i.offsetParent.scrollLeft;S=S+i.offsetParent.scrollTop;}if(i.offsetParent){var
Pa=i.offsetParent.scrollTop;if(!isNaN(Pa))S=S-Pa;var
Ya=i.offsetParent.scrollLeft;if(!isNaN(Ya))ea=ea-Ya;}}i=oa;while((i=i.parentNode)!=null&&i!=d)if(i.parentNode){var
Pa=i.parentNode.scrollTop;if(!isNaN(Pa)&&Pa>0)S=S-Pa;var
Ya=i.parentNode.scrollLeft;if(!isNaN(Ya)&&Ya>0)ea=ea-Ya;}jb.L=eb+ea+2*aa;jb.T=fa+S+2*y;return jb;};r.copy=function(d){window.clipboardData.setData(ub.T,d);};r.paste=function(){return window.clipboardData.getData(ub.T);};r.AU=jsx3.resolveURI(ub.U);r.z9=jsx3.resolveURI(ub.V);r.getCSSFade=function(m){return r.getCSSPNG(m?r.AU:r.z9);};r.getCSSPNG=function(l){return ub.W+l+ub.X;};r.getJSXParent=function(s,o){while(s!=null){if(s.id&&s.id.indexOf(ub.Y)==0){var
P=o?o.getJSXById(s.id):jsx3.GO(s.id);if(P!=null)return P;}if(!s.parentNode){var
ma=s.parentWindow||s.defaultView;s=ma?ma.frameElement:null;}else s=s.parentNode;}return null;};r.removeOutputEscaping=function(h){var
A=h?[h]:[];while(A.length>0){var
M=A.shift();if(M.nodeName&&M.nodeName.toLowerCase()==ub.y&&M.className==ub.Z){M.innerHTML=((((M.innerHTML.replace(ub._,ub.A)).replace(ub.aa,ub.G)).replace(ub.ba,ub.C)).replace(ub.ca,ub.K)).replace(ub.da,r.sA);M.removeAttribute(ub.ea);}else if(M.childNodes)A.push.apply(A,this.nodesToArray(M.childNodes));}};r.removeOutputEscapingSpan=function(k){return k.replace(ub.fa,function(s,f){return ((((f.replace(ub._,ub.A)).replace(ub.aa,ub.G)).replace(ub.ba,ub.C)).replace(ub.ca,ub.K)).replace(ub.da,r.sA);});};r.HZ={nbsp:160,copy:169,reg:174,deg:176,middot:183,le:8804,ge:8805,lt:60,gt:62,euro:8364,ndash:8211,mdash:8212,lsquo:8216,rsquo:8217,ldquo:8220,rdquo:8221,permil:8240};r.sA=function(b,k){var
ua=r.HZ[k];return ua?ub.ga+ua+ub.L:b;};r.ot=ub.ha;r.loadImages=function(j){var
sa=document.getElementById(r.ot);if(sa==null){var
aa=(document.getElementsByTagName(ub.c))[0];if(aa){sa=document.createElement(ub.z);sa.id=r.ot;sa.style.display=ub.ia;aa.insertBefore(sa,aa.firstChild);}else return;}var
ha=jsx3.$A.is(j)?j:arguments;for(var
fb=0;fb<ha.length;fb++){if(!ha[fb])continue;var
La=jsx3.resolveURI(ha[fb]);var
Ca=r.ot+ub.ja+La;if(document.getElementById(Ca)==null){var
y=document.createElement(ub.ka);y.setAttribute(ub.la,Ca);y.setAttribute(ub.ma,La);sa.appendChild(y);}}};r.updateRule=function(a,k,m){var
Ma=jsx3.html.getRuleByName(a);if(Ma)Ma.style[k]=m;};r.getElementById=function(p,k,f){return this.findElements(p,function(e){return e.id==k;},f,false,false,true);};r.getElementByTagName=function(l,j,s){j=j.toLowerCase();return this.findElements(l,function(f){return f.tagName.toLowerCase()==j;},s,false,false,true);};r.getElementsByTagName=function(o,m,c){m=m.toLowerCase();return this.findElements(o,function(h){return h.tagName.toLowerCase()==m;},c,true,false,true);};r.findElements=function(o,p,c,a,n,q){var
Q=c?ub.na:ub.oa;var
C=a?[]:null;var
zb=q?[o]:this.nodesToArray(o.childNodes);while(zb.length>0){var
E=zb.shift();if(p.call(null,E))if(a)C[C.length]=E;else return E;if(!n)zb[Q].apply(zb,this.nodesToArray(E.childNodes));}return C;};r.getElmUpByTagName=function(c,k,o){return r.findElementUp(c,function(s){return s.nodeName.toLowerCase()==k;},o);};r.findElementUp=function(a,s,m){var
Fb=a.ownerDocument.documentElement;var
Va=m?a:a.parentNode;while(Va!=null){if(s.call(null,Va))return Va;if(Va==Fb)break;Va=Va.parentNode;}return null;};r.selectSingleElm=function(e,c){var
jb=1,sb=arguments;if(arguments.length==2)if(typeof c==ub.i){jb=0;sb=c.split(ub.pa);}else if(jsx3.$A.is(c)){jb=0;sb=c;}var
A=e;for(var
Za=jb;A!=null&&Za<sb.length;Za++){var
Fa=sb[Za];if(!isNaN(Fa)){var
qa=Number(Fa);var
hb=A.childNodes.length;var
bb=0,I=0;for(;bb<hb&&I<qa;bb++)if(A.childNodes[bb].nodeType==1)I++;A=A.childNodes[bb];}else throw new
jsx3.Exception();}return A;};r.nodesToArray=function(l){var
Ea=new
Array(l.length);for(var
ia=0;ia<l.length;ia++)Ea[ia]=l[ia];return Ea;};r.getSelection=function(m){return new
r.Selection(m);};r.focusNext=function(n,p){var
fb=n;while(fb.lastChild)fb=fb.lastChild;while(!r.isFocusable(fb)&&fb!=n)fb=fb.previousSibling||fb.parentNode;if(fb!=n||r.isFocusable(fb))if(fb.onfocus!=null){var
I=fb.onfocus;fb.onfocus=null;fb.focus();jsx3.sleep(function(){fb.onfocus=I;});}else fb.focus();};r.focusPrevious=function(s,m){var
la=this.findElements(s,function(p){return r.isFocusable(p);},true,false,false,true);if(la!=null)if(la.onfocus!=null){var
ib=la.onfocus;la.onfocus=null;la.focus();jsx3.sleep(function(){la.onfocus=ib;});}else la.focus();};r._CANTAB=ub.qa;r.focus=function(j){if(j.focus&&r._CANTAB.indexOf((ub.D+j.tagName+ub.D).toUpperCase())>=0){try{j.focus();}catch(Kb){}}else jsx3.gui.Event.dispatchMouseEvent(j,ub.ra,{});};r.addClass=function(f,j){var
_a=f.className;if(_a){if(!(jsx3.$A(_a.split(ub.sa))).contains(j))f.className=_a+ub.D+j;}else f.className=j;};r.removeClass=function(j,n){var
Q=j.className;if(Q&&Q.indexOf(n)>=0){var
Xa=jsx3.$A(Q.split(ub.sa));if(Xa.remove(n))j.className=Xa.join(ub.D);}};});jsx3.Class.defineClass("jsx3.html.Selection",null,null,function(a,n){var
ub={a:"end"};n.init=function(j){this.DY={elm:j,start:j.selectionStart,end:j.selectionEnd,scrollt:j.scrollTop,scrolll:j.scrollLeft};};n.getStartIndex=function(){return this.DY.start;};n.getEndIndex=function(){return this.DY.end;};n.setRange=function(m,p){this.DY.start=m;this.DY.end=p;this.DY.elm.setSelectionRange(m,p);};n.getOffsetLeft=function(){if(this.DY.pos==null)this.DY.pos=jsx3.html.getRelativePosition(null,this.DY.elm);return this.DY.pos.L;};n.getOffsetTop=function(){if(this.DY.pos==null)this.DY.pos=jsx3.html.getRelativePosition(null,this.DY.elm);return this.DY.pos.T;};n.getText=function(){return this.DY.elm.value.substring(this.DY.start,this.DY.end);};n.setText=function(l){this.DY.elm.value=this.DY.elm.value.substring(0,this.DY.start)+l+this.DY.elm.value.substring(this.DY.end);this.DY.elm.setSelectionRange(this.DY.start,this.DY.start+l.length);this.DY.elm.end=this.DY.elm.selectionEnd;};n.insertCaret=function(e){this.DY.elm.focus();if(e==ub.a){this.DY.elm.setSelectionRange(this.DY.elm.end,this.DY.elm.end);}else throw new
